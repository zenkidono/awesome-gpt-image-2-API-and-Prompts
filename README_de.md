...
- [❓ Was ist GPT Image 2?](#-was-ist-gpt-image-2)
- [📰 Neuigkeiten](#-neuigkeiten)
- [🔌 GPT Image 2 API verwenden](#-gpt-image-2-api-verwenden)
- [🛒 E-Commerce-Cases](#-e-commerce-cases)
- [📣 Werbe-Creative-Cases](#-ad-creative-cases)
- [🍌 Portrait- und Fotografie-Cases](#-portrait--photography-cases)
- [🎨 Poster- und Illustrations-Cases](#-poster--illustration-cases)
- [🧍 Charakterdesign-Cases](#-character-design-cases)
- [📱 UI- und Social-Media-Mockup-Cases](#-ui--social-media-mockup-cases)
- [🧪 Vergleichs- und Community-Beispiele](#-comparison--community-examples)
- [🤝 Mitwirken](#-mitwirken)
...
Eine kuratierte Sammlung von **889+ hochwertigen GPT-Image-2 Prompts**, API-Nutzungsmustern und wiederverwendbaren visuellen Workflows für KI-Bildgenerierung.

Wenn du nach GPT-Image-2 Prompt-Beispielen, Best Practices für Text-zu-Bild, Bildbearbeitungstechniken oder direkt nutzbaren Prompt-Vorlagen suchst, findest du hier eine zentrale Referenz.

**Was du hier findest:**
- 🎯 Produktionsreife Prompts in 7 Kategorien (Portrait, Poster, UI, E-Commerce, Werbe-Creatives, Charakterdesign, Vergleich)
- 🔌 Integrationshinweise für die GPT Image 2 API und aufrufbare Skills
- 🌍 Vollständige Dokumentation in 11 Sprachen
- 📸 Reale Ausgabebilder zu jedem Prompt-Case

Auf EvoLink ausführen: [GPT Image 2 API mit Prompts, Doku und erster Anfrage](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)

Wenn dir diese Sammlung hilft, freuen wir uns über einen Star. ⭐
...
**GPT Image 2** (auch GPT-Image-2 oder gpt-image-2 genannt) ist OpenAIs aktuelles Modell für Bildgenerierung und Bildbearbeitung. Es ist nativ in ChatGPT integriert und über die OpenAI API verfügbar.

**Kernfunktionen:**
**Text-zu-Bild-Generierung** — Erstelle fotorealistische Bilder, Illustrationen, Poster, UI-Mockups und mehr aus natürlichsprachlichen Prompts
**Bildbearbeitung** — Verändere bestehende Bilder per Textanweisung (Inpainting, Outpainting, Style Transfer)
**Mehrstufige Dialoge** — Verfeinere Bilder iterativ im Gespräch
**Hochpräzise Textdarstellung** — Rendere Text innerhalb generierter Bilder zuverlässig
**Konsistente Charaktergenerierung** — Bewahre die Identität einer Figur über mehrere Generierungen hinweg

**Warum Entwickler die GPT Image 2 API nutzen:**
Ein API-Aufruf für Generierung und Bearbeitung
Bessere Prompt-Treue als frühere Modelle
Native Unterstützung für Seitenverhältnisse, Transparenz und Batch-Generierung
Kompatibel mit OpenAIs Standard-API-Format (`/v1/images/generations`)

> Mehr zur API-Nutzung findest du im Abschnitt GPT Image 2 API verwenden.

## 📰 Neuigkeiten

**18. Juni 2026:** 8 neue GPT-Image-2-Prompt-Cases hinzugefuegt (2 Portraits, 2 Poster, 2 Werbe-Creatives, 1 E-Commerce, 1 UI) aus dem Image-Prompt-Update-Loop nach semantischer Pruefung und Medienvalidierung

**15. Juni 2026:** 9 neue GPT-Image-2-Prompt-Cases hinzugefügt (4 Werbekreation, 3 Poster, 1 Portrait, 1 UI) aus dem Image-Prompt-Update-Loop nach semantischer Prüfung und Medienvalidierung

**14. Juni 2026:** 14 neue GPT-Image-2-Prompt-Cases hinzugefügt (9 Poster, 2 Werbekreation, 1 Charakter, 1 UI, 1 Vergleich) aus dem Image-Prompt-Update-Loop nach semantischer Prüfung und Medienvalidierung

**12. Juni 2026:** 42 neue GPT-Image-2 Prompt-Cases hinzugefügt (19 Portrait, 12 Poster, 4 Werbe-Creatives, 4 Charakter, 2 Vergleich, 1 E-Commerce) aus dem täglichen Kurationsbatch nach Freigabe und Medienvalidierung; 2 freigegebene Kandidaten wurden übersprungen, weil die Tweet-Abfrage keine nutzbaren Medien zurückgab

**10. Juni 2026:** 31 neue GPT-Image-2 Prompt-Cases hinzugefügt (9 Portrait, 21 Poster, 1 Vergleich) aus dem täglichen Kurationsbatch nach Überprüfung und Medienvalidierung

**9. Juni 2026:** 12 neue GPT-Image-2-Prompt-Fälle hinzugefügt (2 Porträt, 7 Poster, 2 Vergleich, 1 E-Commerce) aus dem täglichen Kuratierungsbatch nach Prüfung und Medienvalidierung

**8. Juni 2026:** 24 neue GPT-Image-2-Prompt-Fälle hinzugefügt (5 Porträt, 7 Poster, 5 UI, 3 E-Commerce, 4 Vergleich) aus dem täglichen Kuratierungsbatch nach Freigabe, Thread-Recovery und Medienvalidierung

**7. Juni 2026:** 19 neue GPT-Image-2-Prompt-Fälle hinzugefügt (2 Porträt, 6 Poster, 5 UI, 4 E-Commerce, 2 Vergleich) aus der täglichen Kuratierung nach Review und Medienvalidierung

**27. Mai 2026:** 6 neue GPT-Image-2-Prompt-Fälle hinzugefügt (1 Porträt, 3 Poster, 1 UI, 1 Vergleich) aus dem täglichen Kuratierungsbatch nach Prüfung und Medienvalidierung

**19. Mai 2026:** 23 neue GPT-Image-2 Prompt-Fälle hinzugefügt (13 Portrait, 8 Poster, 2 UI) aus dem täglichen Curation-Batch



- **12. Mai 2026:** 12 neue GPT-Image-2 Prompt-Fälle hinzugefügt (2 Portrait, 9 Poster, 1 UI) aus der täglichen Kuratierung

- **11. Mai 2026:** 16 neue GPT-Image-2 Prompt-Fälle hinzugefügt (5 Portrait, 8 Poster, 3 Werbekreation) aus der täglichen Kuratierung

- **10. Mai 2026:** 19 neue GPT-Image-2 Prompt-Fälle hinzugefügt (4 Portrait, 11 Poster, 3 UI, 1 Vergleich) aus der täglichen Kuratierung
...
- **6. Mai 2026:** 7 neue GPT-Image-2 Prompt-Fälle hinzugefügt (2 Portrait, 5 Poster) aus dem täglichen Kurationsbatch nach Überprüfung und Medienvalidierung
- **5. Mai 2026:** 12 neue GPT-Image-2 Prompt-Fälle hinzugefügt (4 Portrait, 5 Poster, 3 UI) aus dem täglichen Kurationsbatch
- **3. Mai 2026:** 10 neue GPT-Image-2 Prompt-Fälle hinzugefügt (1 E-Commerce, 1 Werbung, 3 Portrait, 2 Poster, 3 UI)

<details>
<summary>📜 Ältere Updates</summary>

- **2. Mai 2026:** 18 neue Prompt-Fälle hinzugefügt (3 Portrait, 7 Poster, 4 UI, 4 Vergleich)
- **30. April 2026:** 9 neue Prompt-Fälle hinzugefügt (3 Portrait, 1 Poster, 3 UI, 2 Vergleich)
- **29. April 2026:** 22 neue Prompt-Fälle hinzugefügt (3 E-Commerce, 3 Werbung, 4 Portrait, 2 Charakter, 9 Poster, 1 Vergleich)
- **18. April 2026:** Erste Veröffentlichung des Repositories mit kuratierter GPT-Image-2 Fallsammlung

</details>

## 🔌 GPT Image 2 API verwenden

Möchtest du schnell von Prompt-Inspiration zu echter Bildgenerierung wechseln? Nutze die GPT Image 2 API-Dokumentation zusammen mit dem aufrufbaren Skill.

### 1. Skill schnell installieren

- [Zum Repository gpt-image-2-gen-skill wechseln](https://github.com/EvoLinkAI/gpt-image-2-gen-skill)
...
### 2. Schnell mit der API verbinden
...
- [EvoLink-API-Schlüssel abrufen](https://evolink.ai/dashboard?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
- [GPT Image 2 API-Dokumentation ansehen](https://docs.evolink.ai/en/api-manual/image-series/gpt-image-2/gpt-image-2-image-generation?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
### Case 173: [Produktaufnahme mit floralem Serum](https://x.com/iamaiistudio/status/2067413876564795743) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produktaufnahme mit floralem Serum"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produktaufnahme mit floralem Serum"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produktaufnahme mit floralem Serum"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produktaufnahme mit floralem Serum"></a></td></tr>
</table>
...
<!-- Case 174: Eiscreme-Anzeige mit Zutaten-Callouts (by @iamaiistudio) -->
### Case 174: [Eiscreme-Anzeige mit Zutaten-Callouts](https://x.com/iamaiistudio/status/2067465624683700642) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case174/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Eiscreme-Anzeige mit Zutaten-Callouts"></a> |
...
<!-- Case 188: Luxus-Sneaker-Editorialraster (by @iamaiistudio) -->
### Case 188: [Luxus-Sneaker-Editorialraster](https://x.com/iamaiistudio/status/2065964253505585436) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 189: Lifestyle-Anzeige für kabellose Ohrhörer (by @iamaiistudio) -->
### Case 189: [Lifestyle-Anzeige für kabellose Ohrhörer](https://x.com/iamaiistudio/status/2065753093283991651) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Invisible Shield Sonnencreme-Anzeige"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Invisible Shield Sonnencreme-Anzeige"></a></td></tr>
</table>
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Landschaftsillusion mit verstecktem Logo"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Landschaftsillusion mit verstecktem Logo"></a></td></tr>
</table>
...
<!-- Case 194: OBSIDIAN Kaffeemarken-Kampagne (by @iamaiistudio) -->
### Case 194: [OBSIDIAN Kaffeemarken-Kampagne](https://x.com/iamaiistudio/status/2066523210808484228) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case194/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - OBSIDIAN Kaffeemarken-Kampagne"></a> |
...
### Case 195: [Hautpflege-Anzeige "Coconut Paradise"](https://x.com/Strength04_X/status/2067445760325734734) (by [@Strength04_X](https://x.com/Strength04_X))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case195/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Hautpflege-Anzeige Coconut Paradise"></a> |
...
### Case 196: [Produkt-VFX mit Rueckwaertsmontage](https://x.com/iamaiistudio/status/2067399156596175345) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produkt-VFX mit Rueckwaertsmontage"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produkt-VFX mit Rueckwaertsmontage"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produkt-VFX mit Rueckwaertsmontage"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Produkt-VFX mit Rueckwaertsmontage"></a></td></tr>
</table>
...
<!-- Case 197: Produktaufnahme einer Dose mit Trauben-Enthuellung (by @iamaiistudio) -->
### Case 197: [Produktaufnahme einer Dose mit Trauben-Enthuellung](https://x.com/iamaiistudio/status/2067750180724855280) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case197/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Produktaufnahme einer Dose mit Trauben-Enthuellung"></a> |
...
> **126 curated cases** — [Explore all Portrait Prompts →](cases/portrait.md)
...
<!-- Case 304: Nadelgefilzte Wollminiatur (by @iamaiistudio) -->
### Case 304: [Nadelgefilzte Wollminiatur](https://x.com/iamaiistudio/status/2066206049464660301) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case304/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Nadelgefilzte Wollminiatur"></a> |
...
<!-- Case 305: Luftiges japanisches Fensterporträt -->
### Case 305: Luftiges japanisches Fensterporträt
...
### Case 306: [Portraet mit Eiskaffee auf der Parkbank](https://x.com/saniaspeaks_/status/2067451160991084677) (by [@saniaspeaks_](https://x.com/saniaspeaks_))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Portraet mit Eiskaffee auf der Parkbank"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Portraet mit Eiskaffee auf der Parkbank"></a></td></tr>
</table>
...
### Case 307: [Nahportraet mit Curtain Bangs](https://x.com/iamsofiaijaz/status/2067450336378544407) (by [@iamsofiaijaz](https://x.com/iamsofiaijaz))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case307/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Nahportraet mit Curtain Bangs"></a> |
...
<!-- Case 308: Nahaufnahme einer Cyborg-Prothese (by @iamaiistudio) -->
### Case 308: [Nahaufnahme einer Cyborg-Prothese](https://x.com/iamaiistudio/status/2067732972351222060) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case308/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Nahaufnahme einer Cyborg-Prothese"></a> |
...
<!-- Case 309: Sonnenbeschienenes Portraet in mediterraner Gasse (by @iamaiistudio) -->
### Case 309: [Sonnenbeschienenes Portraet in mediterraner Gasse](https://x.com/iamaiistudio/status/2067474399431979223) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case309/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Sonnenbeschienenes Portraet in mediterraner Gasse"></a> |
...
> **145 curated cases** — [Explore all Poster Prompts →](cases/poster.md)
...
<!-- Case 394: Explosionsdiagramm der Sony A7 (by @iamaiistudio) -->
### Case 394: [Explosionsdiagramm der Sony A7](https://x.com/iamaiistudio/status/2066085004116193571) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 395: Biomechanisches Organ-Produkt-Rendering (by @iamaiistudio) -->
### Case 395: [Biomechanisches Organ-Produkt-Rendering](https://x.com/iamaiistudio/status/2066069842407416126) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 396: WPA-Poster zu Sonnenstürmen (by @92digitalartArt) -->
### Case 396: [WPA-Poster zu Sonnenstürmen](https://x.com/92digitalartArt/status/2066062156441735187) (by [@92digitalartArt](https://x.com/92digitalartArt))
...
<!-- Case 397: Premium-Automobil-Spezifikationsposter (by @iamaiistudio) -->
### Case 397: [Premium-Automobil-Spezifikationsposter](https://x.com/iamaiistudio/status/2066055530012111310) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 398: Dopamin-3D-Stadtposter (by @iamaiistudio) -->
### Case 398: [Dopamin-3D-Stadtposter](https://x.com/iamaiistudio/status/2066039955177234472) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 399: Quadratisches professionelles Werbeposter (by @iamaiistudio) -->
### Case 399: [Quadratisches professionelles Werbeposter](https://x.com/iamaiistudio/status/2066024623637188813) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 400: Blockbuster-Actionfilmszene (by @iamaiistudio) -->
### Case 400: [Blockbuster-Actionfilmszene](https://x.com/iamaiistudio/status/2066009564018082289) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 401: Editoriale Tuscheillustrationsvorlage (by @Naiknelofar788) -->
### Case 401: [Editoriale Tuscheillustrationsvorlage](https://x.com/Naiknelofar788/status/2065973105823281314) (by [@Naiknelofar788](https://x.com/Naiknelofar788))
...
<!-- Case 402: Isometrisches Wahrzeichen-Diorama (by @iamaiistudio) -->
### Case 402: [Isometrisches Wahrzeichen-Diorama](https://x.com/iamaiistudio/status/2065737739589615987) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 403: Miniaturwelt mit Aufziehmechanik (by @Gdgtify) -->
### Case 403: [Miniaturwelt mit Aufziehmechanik](https://x.com/Gdgtify/status/2066192943887630372) (by [@Gdgtify](https://x.com/Gdgtify))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case403/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Miniaturwelt mit Aufziehmechanik"></a> |
...
<!-- Case 404: Quallenstadt über den Dünen (by @92digitalartArt) -->
### Case 404: [Quallenstadt über den Dünen](https://x.com/92digitalartArt/status/2066176419038683562) (by [@92digitalartArt](https://x.com/92digitalartArt))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case404/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Quallenstadt über den Dünen"></a> |
...
<!-- Case 405: Tilt-Shift-Reiseposter mit Stadtplan (by @iamaiistudio) -->
### Case 405: [Tilt-Shift-Reiseposter mit Stadtplan](https://x.com/iamaiistudio/status/2066145999266128367) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Tilt-Shift-Reiseposter mit Stadtplan"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Tilt-Shift-Reiseposter mit Stadtplan"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Tilt-Shift-Reiseposter mit Stadtplan"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Tilt-Shift-Reiseposter mit Stadtplan"></a></td></tr>
</table>
...
<!-- Case 406: Eventposter für das AI Music Bootcamp -->
### Case 406: Eventposter für das AI Music Bootcamp
...
### Case 407: [Redaktionelles Poster "Stay Focused"](https://x.com/iamaiistudio/status/2067444516605620410) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case407/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Redaktionelles Poster Stay Focused"></a> |
...
### Case 408: [Chowmein-Rezept-Infografik](https://x.com/iamaiistudio/status/2067429181726904350) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case408/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Chowmein-Rezept-Infografik"></a> |
...
<!-- Case 409: Redaktionelles Poster "New Intelligence" (by @iamaiistudio) -->
### Case 409: [Redaktionelles Poster "New Intelligence"](https://x.com/iamaiistudio/status/2067778187644584418) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case409/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Redaktionelles Poster New Intelligence"></a> |
...
> **12 kuratierte Fälle** — [Alle Character-Design-Prompts ansehen →](cases/character.md)
...
👉 **Alle 14 Character-Design-Prompt-Fälle ansehen →**
...
<!-- Case 23: Surreale Cartoon-Porträtvorlage (by @Goodmanprotocol) -->
### Case 23: [Surreale Cartoon-Porträtvorlage](https://x.com/Goodmanprotocol/status/2066048157805629937) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))
...
<!-- Case 24: Koreanisches Tanz-Bewegungsblatt -->
### Case 24: Koreanisches Tanz-Bewegungsblatt
...
<!-- Case 25: Luminant-Archivist-Charakterposter -->
### Case 25: Luminant-Archivist-Charakterposter
...
### Case 26: [Visual-Novel-Charakterprofil](https://x.com/iamaiistudio/status/2067308176715001944) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/character_case26/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Visual-Novel-Charakterprofil"></a> |
...
<!-- Case 27: Mittelalterliches Alchemisten-Charakterblatt (by @itsPixieVerse) -->
### Case 27: [Mittelalterliches Alchemisten-Charakterblatt](https://x.com/itsPixieVerse/status/2067750004178215241) (by [@itsPixieVerse](https://x.com/itsPixieVerse))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/character_case27/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Mittelalterliches Alchemisten-Charakterblatt"></a> |
...
> **39 curated cases** — [Explore all UI & Mockup Prompts →](cases/ui.md)
...
<!-- Case 183: Portfolioseite im frühen Internetstil (by @Kashberg_0) -->
### Case 183: [Portfolioseite im frühen Internetstil](https://x.com/Kashberg_0/status/2065992579502747850) (by [@Kashberg_0](https://x.com/Kashberg_0))
...
<!-- Case 184: Fototransformation in Buntstiftoptik (by @AIwithSynthia) -->
### Case 184: [Fototransformation in Buntstiftoptik](https://x.com/AIwithSynthia/status/2066154697828782245) (by [@AIwithSynthia](https://x.com/AIwithSynthia))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case184/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Fototransformation in Buntstiftoptik"></a> |
...
<!-- Case 185: Markenidentitätsbogen für ein Maskottchen -->
### Case 185: Markenidentitätsbogen für ein Maskottchen
...
| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case185/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Markenidentitätsbogen für ein Maskottchen"></a> |
...
<!-- Case 186: Architektonische Produktkatalogseite -->
### Case 186: Architektonische Produktkatalogseite
...
### Case 187: [Titelkopf "The King Still Breathes"](https://x.com/NeuralAIInsight/status/2067291988953567706) (by [@NeuralAIInsight](https://x.com/NeuralAIInsight))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ui_case187/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Titelkopf The King Still Breathes"></a> |
...
> **26 kuratierte Fälle** — [Alle Vergleichsbeispiele ansehen →](cases/comparison.md)
...
👉 **Alle 55 Vergleichs- und Community-Prompt-Fälle ansehen →**
...
<!-- Case 105: Muenzrechen-Bearbeitungstest (by @iamaiistudio) -->
### Case 105: [Muenzrechen-Bearbeitungstest](https://x.com/iamaiistudio/status/2065994787094983151) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 106: [Objektschnitt: Blueprint vs. Render](https://x.com/iamaiistudio/status/2067202108303311255) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objektschnitt: Blueprint vs. Render"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objektschnitt: Blueprint vs. Render"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objektschnitt: Blueprint vs. Render"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objektschnitt: Blueprint vs. Render"></a></td></tr>
</table>
...
### Case 107: [Pergola-Split: Blueprint und Bau](https://x.com/iamaiistudio/status/2067142493389603170) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pergola-Split: Blueprint und Bau"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pergola-Split: Blueprint und Bau"></a></td></tr>
</table>
...
Beiträge aus der Community sind willkommen! Wenn du einen starken GPT-Image-2 Prompt erstellt oder entdeckt hast, teile ihn gern mit der Community.

### Möglichkeiten beizutragen

Prompt per Issue einreichen: Nutze unser [Prompt Submission Template](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml), um deinen Prompt mit Ausgabebildern einzureichen.

Pull Request öffnen: Füge deinen Case direkt in die passende Datei unter `cases/*.md` ein und halte dich an das bestehende Format.

Probleme melden: Einen defekten Link oder einen falschen Prompt gefunden? [Issue öffnen](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new).

**Einreichungsrichtlinien:**
- Füge den vollständigen, wiederverwendbaren Prompt-Text hinzu (nicht nur eine Beschreibung)
- Hänge mindestens ein Ausgabebild an oder verlinke es
- Gib an, zu welcher Kategorie dein Prompt gehört
- Nenne den ursprünglichen Autor, wenn du die Arbeit einer anderen Person teilst

Ausführliche Hinweise findest du in [CONTRIBUTING.md](contributing.md).

## Danksagung

Dieses Repository wurde von hervorragenden offenen Prompt-Sammlungen und öffentlich geteilten GPT-Image-2 Experimenten der Community inspiriert.

Danke an alle Creator und Mitwirkenden, die ihre Arbeit öffentlich geteilt und diese Case Studies möglich gemacht haben.
...
> Wir können nicht garantieren, dass jeder Case dem ursprünglichen Creator korrekt zugeordnet ist. Wenn etwas korrigiert werden muss, kontaktiere uns bitte, damit wir es aktualisieren können.

Wenn du weitere interessante GPT-Image-2 Prompt-Cases teilen möchtest, melde dich gern und hilf uns, die Evolink Prompt-Bibliothek zu erweitern.
