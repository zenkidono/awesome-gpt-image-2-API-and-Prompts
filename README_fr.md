...
Transformez n'importe quel prompt de ce dépôt en appel API GPT Image 2 :

<p align="center">
  <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><strong>Lancer l'API GPT Image 2</strong></a> &nbsp;·&nbsp;
  <a href="https://docs.evolink.ai/en/api-manual/image-series/gpt-image-2/gpt-image-2-image-generation?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><strong>Voir la documentation API</strong></a> &nbsp;·&nbsp;
  <a href="https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><strong>Obtenir une clé API</strong></a> &nbsp;·&nbsp;
  <a href="https://github.com/EvoLinkAI/gpt-image-2-gen-skill"><strong>Installer le skill agent</strong></a> &nbsp;·&nbsp;
  <a href="https://github.com/EvoLinkAI/GPT-Image-2-Seedance2-Workflow"><strong>Workflow image-vers-video</strong></a>
</p>
...
- [🔌 Utiliser l'API GPT Image 2](#-utiliser-lapi-gpt-image-2)
- [🛒 Cas e-commerce](#-e-commerce-cases)
- [📣 Cas de créations publicitaires](#-ad-creative-cases)
- [🍌 Cas portrait et photographie](#-portrait--photography-cases)
- [🎨 Cas affiche et illustration](#-poster--illustration-cases)
- [🧍 Cas de design de personnage](#-character-design-cases)
- [📱 Cas UI et mockups réseaux sociaux](#-ui--social-media-mockup-cases)
- [🧪 Comparaisons et exemples communautaires](#-comparison--community-examples)
...
**Vous trouverez ici :**
- 🎯 Des prompts prêts pour la production dans 7 catégories (portrait, affiche, UI, e-commerce, création publicitaire, design de personnage, comparaison)
- 🔌 Des guides d'intégration de l'API GPT Image 2 et des skills appelables
- 🌍 Une documentation complète en 11 langues
- 📸 De vraies images de sortie pour chaque cas de prompt

Exécutez-le sur EvoLink : [API GPT Image 2 avec prompts, documentation et première requête](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)

Si ce dépôt vous est utile, pensez à lui donner une étoile. ⭐
...
**GPT Image 2** (aussi appelé GPT-Image-2 ou gpt-image-2) est le modèle de génération et d'édition d'images d'OpenAI, intégré nativement dans ChatGPT et disponible via l'API OpenAI.

**Capacités clés :**
**Génération text-to-image** — créer des images photoréalistes, illustrations, affiches, maquettes UI et autres visuels à partir d'instructions en langage naturel
**Édition d'image** — modifier des images existantes avec des instructions textuelles (inpainting, outpainting, transfert de style)
**Conversations multi-tours** — affiner progressivement les images par le dialogue
**Rendu fidèle du texte** — générer du texte lisible et précis dans les images
**Cohérence des personnages** — conserver l'identité d'un personnage sur plusieurs générations

**Pourquoi les développeurs utilisent l'API GPT Image 2 :**
Un seul appel d'API pour la génération et l'édition
Une meilleure adhérence au prompt que les modèles précédents
La prise en charge native des ratios, de la transparence et de la génération par lots
La compatibilité avec le format d'API OpenAI standard (`/v1/images/generations`)
...
**14 juin 2026 :** Ajout de 14 nouveaux cas de prompts GPT-Image-2 (9 affiches, 2 créations publicitaires, 1 personnage, 1 UI, 1 comparaison) issus de la boucle de mise à jour des prompts image après revue sémantique et validation des médias

**12 juin 2026 :** Ajout de 42 nouveaux cas de prompts GPT-Image-2 (19 portraits, 12 affiches, 4 créations publicitaires, 4 personnages, 2 comparaisons, 1 e-commerce) issus du lot de curation quotidien après approbation et validation des médias ; 2 candidats approuvés ont été ignorés car la recherche du tweet n’a renvoyé aucun média utilisable

**10 juin 2026 :** 31 nouveaux cas de prompts GPT-Image-2 ajoutés (9 portraits, 21 affiches, 1 comparaison) depuis le lot de curation quotidien après révision et validation des médias

**9 juin 2026:** 12 nouveaux cas de prompts GPT-Image-2 ajoutés (2 portrait, 7 poster, 2 comparaison, 1 e-commerce) du lot de curation quotidien après révision et validation des médias

**8 juin 2026 :** Ajout de 24 nouveaux cas de prompts GPT-Image-2 (5 portrait, 7 poster, 5 UI, 3 e-commerce, 4 comparaison) issus du lot quotidien après approbation, récupération des threads et validation des médias

**7 juin 2026 :** Ajout de 19 nouveaux cas de prompts GPT-Image-2 (2 portrait, 6 poster, 5 UI, 4 e-commerce, 2 comparaison) issus du lot quotidien après revue et validation des médias
...
- **12 mai 2026 :** Ajout de 12 nouveaux cas de prompts GPT-Image-2 (2 portrait, 9 poster, 1 UI) du lot de curation quotidien

- **11 mai 2026 :** Ajout de 16 nouveaux cas de prompts GPT-Image-2 (5 portrait, 8 poster, 3 création publicitaire) du lot de curation quotidien

- **10 mai 2026 :** Ajout de 19 nouveaux cas de prompts GPT-Image-2 (4 portrait, 11 poster, 3 UI, 1 comparaison) du lot de curation quotidien

- **9 mai 2026 :** Ajout de 19 nouveaux cas de prompts GPT-Image-2 (6 portrait, 12 poster, 1 comparaison) du lot de curation quotidien

- **8 mai 2026 :** Ajout de 36 nouveaux cas de prompts GPT-Image-2 (24 portrait, 6 poster, 6 UI) du lot de curation quotidien
- **7 mai 2026 :** Ajout de 20 nouveaux cas de prompts GPT-Image-2 (10 portrait, 9 poster, 1 UI) du lot de curation quotidien

- **6 mai 2026 :** Ajout de 7 nouveaux cas de prompts GPT-Image-2 (2 portrait, 5 affiche)
- **5 mai 2026 :** Ajout de 12 nouveaux cas de prompts GPT-Image-2 (4 portrait, 5 affiche, 3 UI)
- **3 mai 2026 :** Ajout de 10 nouveaux cas de prompts GPT-Image-2 (1 e-commerce, 1 publicité, 3 portrait, 2 affiche, 3 UI)

<details>
<summary>📜 Mises à jour précédentes</summary>

- **2 mai 2026 :** Ajout de 18 nouveaux cas (3 portrait, 7 affiche, 4 UI, 4 comparaison)
- **30 avril 2026 :** Ajout de 9 nouveaux cas (3 portrait, 1 affiche, 3 UI, 2 comparaison)
- **29 avril 2026 :** Ajout de 22 nouveaux cas (3 e-commerce, 3 publicité, 4 portrait, 2 personnage, 9 affiche, 1 comparaison)
- **18 avril 2026 :** Première publication du dépôt avec un ensemble organisé de cas GPT-Image-2

</details>

## 🔌 Utiliser l'API GPT Image 2

Vous voulez passer rapidement d'une inspiration de prompt à une génération d'image réelle ? Utilisez la documentation de l'API GPT Image 2 avec le skill appelable.

### 1. Installation rapide du skill

- [Accéder au dépôt gpt-image-2-gen-skill](https://github.com/EvoLinkAI/gpt-image-2-gen-skill)
...
- [Obtenir votre clé API EvoLink](https://evolink.ai/dashboard?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
- [Voir la documentation de l'API GPT Image 2](https://docs.evolink.ai/en/api-manual/image-series/gpt-image-2/gpt-image-2-image-generation?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
👉 **[Voir les 20 cas de prompts e-commerce →](cases/ecommerce.md)**
...
<!-- Case 174: Publicite pour glace avec ingredients mis en avant (by @iamaiistudio) -->
### Case 174: [Publicite pour glace avec ingredients mis en avant](https://x.com/iamaiistudio/status/2067465624683700642) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case174/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Publicite pour glace avec ingredients mis en avant"></a> |
...
👉 **Voir les 19 cas de prompts de créations publicitaires →**
...
<!-- Case 188: Grille éditoriale de sneakers de luxe (by @iamaiistudio) -->
### Case 188: [Grille éditoriale de sneakers de luxe](https://x.com/iamaiistudio/status/2065964253505585436) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 189: Publicité lifestyle pour écouteurs sans fil (by @iamaiistudio) -->
### Case 189: [Publicité lifestyle pour écouteurs sans fil](https://x.com/iamaiistudio/status/2065753093283991651) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Publicité pour crème solaire Invisible Shield"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Publicité pour crème solaire Invisible Shield"></a></td></tr>
</table>
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Illusion de paysage au logo caché"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Illusion de paysage au logo caché"></a></td></tr>
</table>
...
| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case197/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Photo produit de canette avec revelation de raisins"></a> |
...
👉 **Voir les 68 cas de prompts portrait et photographie →**
...
<!-- Case 304: Miniature en laine feutrée à l'aiguille (by @iamaiistudio) -->
### Case 304: [Miniature en laine feutrée à l'aiguille](https://x.com/iamaiistudio/status/2066206049464660301) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case304/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Miniature en laine feutrée à l'aiguille"></a> |
...
<!-- Case 308: Gros plan sur prothese cyborg (by @iamaiistudio) -->
### Case 308: [Gros plan sur prothese cyborg](https://x.com/iamaiistudio/status/2067732972351222060) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 309: Portrait ensoleille dans une ruelle mediterraneenne (by @iamaiistudio) -->
### Case 309: [Portrait ensoleille dans une ruelle mediterraneenne](https://x.com/iamaiistudio/status/2067474399431979223) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
👉 **Voir les 119 cas de prompts affiche et illustration →**
...
<!-- Case 394: Schéma éclaté du Sony A7 (by @iamaiistudio) -->
### Case 394: [Schéma éclaté du Sony A7](https://x.com/iamaiistudio/status/2066085004116193571) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 395: Rendu produit d’organe biomécanique (by @iamaiistudio) -->
### Case 395: [Rendu produit d’organe biomécanique](https://x.com/iamaiistudio/status/2066069842407416126) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 396: Affiche WPA sur les tempêtes solaires (by @92digitalartArt) -->
### Case 396: [Affiche WPA sur les tempêtes solaires](https://x.com/92digitalartArt/status/2066062156441735187) (by [@92digitalartArt](https://x.com/92digitalartArt))
...
<!-- Case 397: Affiche premium de fiche technique automobile (by @iamaiistudio) -->
### Case 397: [Affiche premium de fiche technique automobile](https://x.com/iamaiistudio/status/2066055530012111310) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 398: Affiche urbaine 3D dopamine (by @iamaiistudio) -->
### Case 398: [Affiche urbaine 3D dopamine](https://x.com/iamaiistudio/status/2066039955177234472) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 399: Affiche publicitaire professionnelle carrée (by @iamaiistudio) -->
### Case 399: [Affiche publicitaire professionnelle carrée](https://x.com/iamaiistudio/status/2066024623637188813) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 400: Plan de film d’action blockbuster (by @iamaiistudio) -->
### Case 400: [Plan de film d’action blockbuster](https://x.com/iamaiistudio/status/2066009564018082289) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 401: Modèle d’illustration éditoriale à l’encre (by @Naiknelofar788) -->
### Case 401: [Modèle d’illustration éditoriale à l’encre](https://x.com/Naiknelofar788/status/2065973105823281314) (by [@Naiknelofar788](https://x.com/Naiknelofar788))
...
<!-- Case 402: Diorama isométrique de monument emblématique (by @iamaiistudio) -->
### Case 402: [Diorama isométrique de monument emblématique](https://x.com/iamaiistudio/status/2065737739589615987) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 403: Monde miniature à remontoir (by @Gdgtify) -->
### Case 403: [Monde miniature à remontoir](https://x.com/Gdgtify/status/2066192943887630372) (by [@Gdgtify](https://x.com/Gdgtify))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case403/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Monde miniature à remontoir"></a> |
...
<!-- Case 404: Ville de méduses au-dessus des dunes (by @92digitalartArt) -->
### Case 404: [Ville de méduses au-dessus des dunes](https://x.com/92digitalartArt/status/2066176419038683562) (by [@92digitalartArt](https://x.com/92digitalartArt))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case404/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Ville de méduses au-dessus des dunes"></a> |
...
<!-- Case 405: Affiche de voyage tilt-shift sur plan de ville (by @iamaiistudio) -->
### Case 405: [Affiche de voyage tilt-shift sur plan de ville](https://x.com/iamaiistudio/status/2066145999266128367) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Affiche de voyage tilt-shift sur plan de ville"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Affiche de voyage tilt-shift sur plan de ville"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Affiche de voyage tilt-shift sur plan de ville"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Affiche de voyage tilt-shift sur plan de ville"></a></td></tr>
</table>
...
<!-- Case 406: Affiche d'événement AI Music Bootcamp (by @iamaiistudio) -->
### Case 406: [Affiche d'événement AI Music Bootcamp](https://x.com/iamaiistudio/status/2066538267835867647) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case406/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Affiche d'événement AI Music Bootcamp"></a> |
...
<!-- Case 409: Affiche editoriale "New Intelligence" (by @iamaiistudio) -->
### Case 409: [Affiche editoriale "New Intelligence"](https://x.com/iamaiistudio/status/2067778187644584418) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case409/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Affiche editoriale New Intelligence"></a> |
...
👉 **Voir les 14 cas de prompts de design de personnage →**
...
<!-- Case 23: Modèle de portrait cartoon surréaliste (by @Goodmanprotocol) -->
### Case 23: [Modèle de portrait cartoon surréaliste](https://x.com/Goodmanprotocol/status/2066048157805629937) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))
...
<!-- Case 24: Planche de mouvements de danse coréenne -->
### Case 24: Planche de mouvements de danse coréenne
...
<!-- Case 25: Affiche de personnage Luminant Archivist -->
### Case 25: Affiche de personnage Luminant Archivist
...
### Case 26: [Profil de personnage de visual novel](https://x.com/iamaiistudio/status/2067308176715001944) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/character_case26/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Profil de personnage de visual novel"></a> |
...
<!-- Case 27: Fiche personnage d'alchimiste medieval (by @itsPixieVerse) -->
### Case 27: [Fiche personnage d'alchimiste medieval](https://x.com/itsPixieVerse/status/2067750004178215241) (by [@itsPixieVerse](https://x.com/itsPixieVerse))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/character_case27/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Fiche personnage d'alchimiste medieval"></a> |
...
👉 **Voir les 67 cas de prompts UI et mockups réseaux sociaux →**
...
<!-- Case 183: Page portfolio façon premiers temps du Web (by @Kashberg_0) -->
### Case 183: [Page portfolio façon premiers temps du Web](https://x.com/Kashberg_0/status/2065992579502747850) (by [@Kashberg_0](https://x.com/Kashberg_0))
...
<!-- Case 184: Transformation photo aux crayons de couleur (by @AIwithSynthia) -->
### Case 184: [Transformation photo aux crayons de couleur](https://x.com/AIwithSynthia/status/2066154697828782245) (by [@AIwithSynthia](https://x.com/AIwithSynthia))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case184/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Transformation photo aux crayons de couleur"></a> |
...
<!-- Case 185: Planche d'identité de marque avec mascotte (by @iamaiistudio) -->
### Case 185: [Planche d'identité de marque avec mascotte](https://x.com/iamaiistudio/status/2066568983453880412) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case185/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Planche d'identité de marque avec mascotte"></a> |
...
<!-- Case 186: Page de catalogue produit architecturale (by @iamaiistudio) -->
### Case 186: [Page de catalogue produit architecturale](https://x.com/iamaiistudio/status/2066447564132745574) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case186/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Page de catalogue produit architecturale"></a> |
...
> **26 cas sélectionnés** — [Explorer tous les exemples de comparaison →](cases/comparison.md)
...
👉 **Voir les 55 cas de prompts de comparaison et exemples communautaires →**
...
<!-- Case 105: Test d’édition de calcul de pièces (by @iamaiistudio) -->
### Case 105: [Test d’édition de calcul de pièces](https://x.com/iamaiistudio/status/2065994787094983151) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 106: [Objet scindé : plan vs rendu](https://x.com/iamaiistudio/status/2067202108303311255) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objet scindé : plan vs rendu"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objet scindé : plan vs rendu"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objet scindé : plan vs rendu"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objet scindé : plan vs rendu"></a></td></tr>
</table>
...
### Case 107: [Pérgola scindée : plan et construction](https://x.com/iamaiistudio/status/2067142493389603170) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pérgola scindée : plan et construction"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pérgola scindée : plan et construction"></a></td></tr>
</table>
...
Les contributions de la communauté sont les bienvenues ! Si vous avez créé ou découvert un excellent prompt GPT-Image-2, partagez-le avec la communauté.

### Façons de contribuer

Soumettre un prompt via une Issue : utilisez notre [modèle de soumission de prompt](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml) pour envoyer votre prompt avec ses images de sortie.

Ouvrir une Pull Request : ajoutez directement votre cas au fichier `cases/*.md` approprié en respectant le format existant.

Signaler un problème : lien cassé, prompt incorrect ou attribution à corriger ? [Ouvrez une issue](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new).

**Consignes de soumission :**
- Inclure le texte complet et réutilisable du prompt, pas seulement une description
- Joindre ou lier au moins une image de sortie
- Préciser la catégorie du prompt
- Créditer l'auteur original si vous partagez le travail de quelqu'un d'autre

Consultez [CONTRIBUTING.md](contributing.md) pour les consignes détaillées.

## Remerciements

Ce dépôt s'inspire d'excellentes collections ouvertes de prompts et d'expériences GPT-Image-2 partagées par la communauté.

Merci aux créateurs et contributeurs qui ont partagé publiquement leur travail et rendu ces études de cas possibles.
...
> Nous ne pouvons pas garantir que chaque cas est attribué à son créateur original. Si une correction est nécessaire, contactez-nous et nous la mettrons à jour.

Si vous avez d'autres cas de prompts GPT-Image-2 intéressants à partager, n'hésitez pas à nous contacter et à nous aider à enrichir la bibliothèque de prompts Evolink.
