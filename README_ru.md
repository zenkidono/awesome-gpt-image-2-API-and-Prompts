...
- [🍌 Введение](#-введение)
- [❓ Что такое GPT Image 2](#-что-такое-gpt-image-2)
- [📰 Новости](#-новости)
- [🔌 Использование API GPT Image 2](#-использование-api-gpt-image-2)
- [🛒 Кейсы для e-commerce](#-кейсы-для-e-commerce)
- [📣 Кейсы рекламных креативов](#-кейсы-рекламных-креативов)
...
Это тщательно отобранная коллекция из **889+ качественных промптов GPT-Image-2**, паттернов работы с API и переиспользуемых визуальных workflow для генерации изображений с AI.
...
**Что здесь есть:**
- 🎯 Готовые к продакшену промпты в 7 категориях: портреты, постеры, UI, e-commerce, рекламные креативы, дизайн персонажей и сравнения
- 🔌 Руководства по интеграции GPT Image 2 API и вызываемые skill-пакеты
- 🌍 Полная документация на 11 языках
- 📸 Реальные выходные изображения для каждого prompt case

Попробовать в Evolink: [GPT-Image-2 API](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)

Если репозиторий оказался полезен, поставьте ему звезду. ⭐
...
**GPT Image 2** (также GPT-Image-2 или gpt-image-2) — новейшая модель OpenAI для генерации и редактирования изображений, нативно встроенная в ChatGPT и доступная через OpenAI API.

**Ключевые возможности:**
**Генерация text-to-image** — создавайте фотореалистичные изображения, иллюстрации, постеры, UI-мокапы и другие визуалы по промптам на естественном языке
**Редактирование изображений** — изменяйте существующие изображения текстовыми инструкциями: inpainting, outpainting, перенос стиля
**Многошаговый диалог** — итеративно уточняйте изображение в разговоре
**Точная отрисовка текста** — аккуратно рендерьте текст внутри сгенерированных изображений
**Согласованные персонажи** — сохраняйте идентичность персонажа между несколькими генерациями

**Почему разработчики используют GPT Image 2 API:**
Один API-вызов для генерации и редактирования
Более точное следование промпту по сравнению с предыдущими моделями
Нативная поддержка соотношений сторон, прозрачности и пакетной генерации
Совместимость со стандартным API-форматом OpenAI (`/v1/images/generations`)

> Подробнее об API смотрите в разделе «Использование API GPT Image 2» ниже.

## 📰 Новости

**18 июня 2026 г.:** из ежедневного цикла image-prompt добавлено 8 кейсов промптов GPT-Image-2 (2 портрета, 2 постера, 2 рекламных креатива, 1 e-commerce, 1 UI); выполнены семантическая проверка и валидация медиа

**18 июня 2026 г.:** Добавлено 8 новых prompt case для GPT-Image-2 (2 портрета, 2 постера, 2 рекламных креатива, 1 e-commerce, 1 UI) из цикла обновления image prompt после семантической проверки и валидации медиа

**15 июня 2026 г.:** Добавлено 9 новых prompt case для GPT-Image-2 (4 рекламных креатива, 3 постера, 1 портрет, 1 UI) из цикла обновления image prompt после семантической проверки и валидации медиа

**14 июня 2026 г.:** Добавлено 14 новых prompt case для GPT-Image-2 (9 постеров, 2 рекламных креатива, 1 персонаж, 1 UI, 1 сравнение) из цикла обновления image prompt после семантической проверки и валидации медиа

**12 июня 2026 г.:** Добавлено 42 новых prompt case для GPT-Image-2 (19 портретов, 12 постеров, 4 рекламных креатива, 4 персонажа, 2 сравнения, 1 e-commerce) из ежедневной кураторской партии после одобрения и валидации медиа; 2 одобренных кандидата пропущены, потому что поиск твита не вернул пригодных медиа

**10 июня 2026 г.:** Добавлено 30 новых промпт-кейсов GPT-Image-2 (9 портретов, 21 постер, 1 сравнение) из ежедневной кураторской партии после проверки и валидации медиаматериалов

**9 июня 2026 г.:** Добавлено 12 новых случаев подсказок GPT-Image-2 (2 портрет, 7 постер, 2 сравнение, 1 электронная коммерция) из ежедневной партии кураторства после проверки и валидации медиа

**8 июня 2026:** Добавлено 24 новых кейса промптов GPT-Image-2 (5 портрет, 7 постер, 5 UI, 3 e-commerce, 4 сравнение) из ежедневной курации после одобрения, восстановления тредов и проверки медиа

**7 июня 2026:** Добавлено 19 новых кейсов промптов GPT-Image-2 (2 портрет, 6 постер, 5 UI, 4 e-commerce, 2 сравнение) из ежедневной курации после ревью и проверки медиа

**27 мая 2026:** Добавлено 6 новых кейсов промптов GPT-Image-2 (1 портрет, 3 постер, 1 UI, 1 сравнение) из ежедневной курации после проверки и валидации медиа

**19 мая 2026 г.:** Добавлено 23 новых случая промптов GPT-Image-2 (13 портрет, 8 постер, 2 UI) из ежедневного пакета курирования



- **12 мая 2026:** Добавлено 12 новых кейсов промптов GPT-Image-2 (2 портрет, 9 постер, 1 UI) из ежедневной курации
...
- **8 мая 2026:** Добавлено 36 новых кейсов промптов GPT-Image-2 (24 портрет, 6 постер, 6 UI) из ежедневной курации
- **7 мая 2026:** Добавлено 20 новых кейсов промптов GPT-Image-2 (10 портрет, 9 постер, 1 UI) из ежедневной курации
- **6 мая 2026:** Добавлено 7 новых кейсов промптов GPT-Image-2 (2 портрет, 5 постер)
- **5 мая 2026:** Добавлено 12 новых кейсов промптов GPT-Image-2 (4 портрет, 5 постер, 3 UI)
- **3 мая 2026:** Добавлено 10 новых кейсов промптов GPT-Image-2 (1 e-commerce, 1 реклама, 3 портрет, 2 постер, 3 UI)

<details>
<summary>📜 Предыдущие обновления</summary>

- **2 мая 2026:** Добавлено 18 новых кейсов (3 портрет, 7 постер, 4 UI, 4 сравнение)
- **30 апреля 2026:** Добавлено 9 новых кейсов (3 портрет, 1 постер, 3 UI, 2 сравнение)
- **29 апреля 2026:** Добавлено 22 новых кейса (3 e-commerce, 3 реклама, 4 портрет, 2 персонаж, 9 постер, 1 сравнение)
- **18 апреля 2026:** Первый релиз репозитория с подобранной коллекцией кейсов GPT-Image-2

</details>

## 🔌 Использование API GPT Image 2

Хотите быстро перейти от вдохновения промптами к реальной генерации изображений? Используйте документацию GPT Image 2 API вместе с вызываемым skill-пакетом.

### 1. Быстрая установка skill

- [Перейти в репозиторий gpt-image-2-gen-skill](https://github.com/EvoLinkAI/gpt-image-2-gen-skill)
...
- [Получить API-ключ](https://evolink.ai/dashboard?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
- Читать документацию GPT Image 2 API

## 🛒 Кейсы для e-commerce

> **14 отобранных кейсов**
...
<!-- Case 173: Предметная съемка цветочной сыворотки (by @iamaiistudio) -->
### Case 173: [Предметная съемка цветочной сыворотки](https://x.com/iamaiistudio/status/2067413876564795743) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Предметная съемка цветочной сыворотки"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Предметная съемка цветочной сыворотки"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Предметная съемка цветочной сыворотки"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Предметная съемка цветочной сыворотки"></a></td></tr>
</table>
...
<!-- Case 174: Реклама мороженого с акцентом на ингредиенты (by @iamaiistudio) -->
### Case 174: [Реклама мороженого с акцентом на ингредиенты](https://x.com/iamaiistudio/status/2067465624683700642) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
> **26 отобранных кейса** — [Все промпты для рекламных креативов →](cases/ad-creative.md)
...
<!-- Case 188: Редакционная сетка люксовых кроссовок (by @iamaiistudio) -->
### Case 188: [Редакционная сетка люксовых кроссовок](https://x.com/iamaiistudio/status/2065964253505585436) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 189: Лайфстайл-реклама беспроводных наушников (by @iamaiistudio) -->
### Case 189: [Лайфстайл-реклама беспроводных наушников](https://x.com/iamaiistudio/status/2065753093283991651) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 190: Сцена с креслом-качелями Kinder Joy (by @iamaiistudio) -->
### Case 190: [Сцена с креслом-качелями Kinder Joy](https://x.com/iamaiistudio/status/2066312771978092587) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case190/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Сцена с креслом-качелями Kinder Joy"></a> |
...
<!-- Case 191: Реклама солнцезащитного крема «Невидимый щит» (by @iamrealsnow) -->
### Case 191: [Реклама солнцезащитного крема «Невидимый щит»](https://x.com/iamrealsnow/status/2066200217347854445) (by [@iamrealsnow](https://x.com/iamrealsnow))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Реклама солнцезащитного крема «Невидимый щит»"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Реклама солнцезащитного крема «Невидимый щит»"></a></td></tr>
</table>
...
<!-- Case 192: Пейзажная иллюзия со скрытым логотипом (by @iamaiistudio) -->
### Case 192: [Пейзажная иллюзия со скрытым логотипом](https://x.com/iamaiistudio/status/2066191259354689714) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Пейзажная иллюзия со скрытым логотипом"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Пейзажная иллюзия со скрытым логотипом"></a></td></tr>
</table>
...
<!-- Case 193: Модный постер с жидким логотипом SPLASH (by @iamaiistudio) -->
### Case 193: [Модный постер с жидким логотипом SPLASH](https://x.com/iamaiistudio/status/2065979523229975021) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case193/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Модный постер с жидким логотипом SPLASH"></a> |
...
<!-- Case 195: Реклама ухода Coconut Paradise (by @Strength04_X) -->
### Case 195: [Реклама ухода Coconut Paradise](https://x.com/Strength04_X/status/2067445760325734734) (by [@Strength04_X](https://x.com/Strength04_X))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case195/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Реклама ухода Coconut Paradise"></a> |
...
<!-- Case 196: VFX продукта с обратной сборкой (by @iamaiistudio) -->
### Case 196: [VFX продукта с обратной сборкой](https://x.com/iamaiistudio/status/2067399156596175345) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX продукта с обратной сборкой"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX продукта с обратной сборкой"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX продукта с обратной сборкой"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX продукта с обратной сборкой"></a></td></tr>
</table>
...
<!-- Case 197: Предметная съемка банки с раскрытием винограда (by @iamaiistudio) -->
### Case 197: [Предметная съемка банки с раскрытием винограда](https://x.com/iamaiistudio/status/2067750180724855280) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
> **128 отобранных кейсов** — [Все промпты для портретов →](cases/portrait.md)
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Портрет с айс-кофе на скамейке"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Портрет с айс-кофе на скамейке"></a></td></tr>
</table>
...
| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case307/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Крупный портрет с челкой-шторкой"></a> |
...
<!-- Case 308: Крупный план кибернетического протеза (by @iamaiistudio) -->
...
<!-- Case 309: Солнечный портрет в средиземноморском переулке (by @iamaiistudio) -->
...
> **147 отобранных кейсов** — [Все промпты для постеров →](cases/poster.md)
...
<!-- Case 394: Взрыв-схема Sony A7 (by @iamaiistudio) -->
### Case 394: [Взрыв-схема Sony A7](https://x.com/iamaiistudio/status/2066085004116193571) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 395: Биомеханический рендер органа как продукта (by @iamaiistudio) -->
### Case 395: [Биомеханический рендер органа как продукта](https://x.com/iamaiistudio/status/2066069842407416126) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 396: WPA-постер о солнечной буре (by @92digitalartArt) -->
### Case 396: [WPA-постер о солнечной буре](https://x.com/92digitalartArt/status/2066062156441735187) (by [@92digitalartArt](https://x.com/92digitalartArt))
...
<!-- Case 397: Премиальный постер с характеристиками автомобиля (by @iamaiistudio) -->
### Case 397: [Премиальный постер с характеристиками автомобиля](https://x.com/iamaiistudio/status/2066055530012111310) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 398: Дофаминовый городской 3D-постер (by @iamaiistudio) -->
### Case 398: [Дофаминовый городской 3D-постер](https://x.com/iamaiistudio/status/2066039955177234472) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 399: Квадратный профессиональный рекламный постер (by @iamaiistudio) -->
### Case 399: [Квадратный профессиональный рекламный постер](https://x.com/iamaiistudio/status/2066024623637188813) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 400: Кадр из блокбастерного экшен-фильма (by @iamaiistudio) -->
### Case 400: [Кадр из блокбастерного экшен-фильма](https://x.com/iamaiistudio/status/2066009564018082289) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 401: Шаблон редакционной тушевой иллюстрации (by @Naiknelofar788) -->
### Case 401: [Шаблон редакционной тушевой иллюстрации](https://x.com/Naiknelofar788/status/2065973105823281314) (by [@Naiknelofar788](https://x.com/Naiknelofar788))
...
<!-- Case 402: Изометрическая диорама достопримечательности (by @iamaiistudio) -->
### Case 402: [Изометрическая диорама достопримечательности](https://x.com/iamaiistudio/status/2065737739589615987) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 403: Заводной миниатюрный мир (by @Gdgtify) -->
### Case 403: [Заводной миниатюрный мир](https://x.com/Gdgtify/status/2066192943887630372) (by [@Gdgtify](https://x.com/Gdgtify))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case403/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Заводной миниатюрный мир"></a> |
...
<!-- Case 404: Город медуз над дюнами (by @92digitalartArt) -->
### Case 404: [Город медуз над дюнами](https://x.com/92digitalartArt/status/2066176419038683562) (by [@92digitalartArt](https://x.com/92digitalartArt))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case404/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Город медуз над дюнами"></a> |
...
<!-- Case 405: Туристический постер с картой города в стиле tilt-shift (by @iamaiistudio) -->
### Case 405: [Туристический постер с картой города в стиле tilt-shift](https://x.com/iamaiistudio/status/2066145999266128367) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Туристический постер с картой города в стиле tilt-shift"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Туристический постер с картой города в стиле tilt-shift"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Туристический постер с картой города в стиле tilt-shift"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Туристический постер с картой города в стиле tilt-shift"></a></td></tr>
</table>
...
<!-- Case 407: Редакционный постер Stay Focused (by @iamaiistudio) -->
### Case 407: [Редакционный постер Stay Focused](https://x.com/iamaiistudio/status/2067444516605620410) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case407/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Редакционный постер Stay Focused"></a> |
...
<!-- Case 408: Инфографика рецепта чаомэня (by @iamaiistudio) -->
### Case 408: [Инфографика рецепта чаомэня](https://x.com/iamaiistudio/status/2067429181726904350) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case408/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Инфографика рецепта чаомэня"></a> |
...
<!-- Case 409: Редакционный постер New Intelligence (by @iamaiistudio) -->
### Case 409: [Редакционный постер New Intelligence](https://x.com/iamaiistudio/status/2067778187644584418) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
> **12 отобранных кейсов** — [Все промпты для дизайна персонажей →](cases/character.md)
...
👉 **Все 14 prompt case для дизайна персонажей →**
...
<!-- Case 23: Сюрреалистический шаблон мультяшного портрета (by @Goodmanprotocol) -->
### Case 23: [Сюрреалистический шаблон мультяшного портрета](https://x.com/Goodmanprotocol/status/2066048157805629937) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))
...
### Case 26: [Профиль персонажа визуальной новеллы](https://x.com/iamaiistudio/status/2067308176715001944) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Результат:**

| Результат |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/character_case26/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Профиль персонажа визуальной новеллы"></a> |
...
<!-- Case 27: Лист персонажа средневекового алхимика (by @itsPixieVerse) -->
### Case 27: [Лист персонажа средневекового алхимика](https://x.com/itsPixieVerse/status/2067750004178215241) (by [@itsPixieVerse](https://x.com/itsPixieVerse))
...
> **40 отобранных кейсов** — [Все промпты для UI и мокапов →](cases/ui.md)
...
<!-- Case 183: Страница портфолио в стиле раннего интернета (by @Kashberg_0) -->
### Case 183: [Страница портфолио в стиле раннего интернета](https://x.com/Kashberg_0/status/2065992579502747850) (by [@Kashberg_0](https://x.com/Kashberg_0))
...
<!-- Case 184: Преобразование фотографии в рисунок цветными карандашами (by @AIwithSynthia) -->
### Case 184: [Преобразование фотографии в рисунок цветными карандашами](https://x.com/AIwithSynthia/status/2066154697828782245) (by [@AIwithSynthia](https://x.com/AIwithSynthia))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case184/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Преобразование фотографии в рисунок цветными карандашами"></a> |
...
<!-- Case 187: Мастхед The King Still Breathes (by @NeuralAIInsight) -->
### Case 187: [Мастхед The King Still Breathes](https://x.com/NeuralAIInsight/status/2067291988953567706) (by [@NeuralAIInsight](https://x.com/NeuralAIInsight))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ui_case187/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Мастхед The King Still Breathes"></a> |
...
👉 **Все 55 prompt case для сравнений и примеров сообщества →**
...
<!-- Case 105: Тест редактирования с подсчетом монет (by @iamaiistudio) -->
### Case 105: [Тест редактирования с подсчетом монет](https://x.com/iamaiistudio/status/2065994787094983151) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 106: [Объект в сплите: чертеж и рендер](https://x.com/iamaiistudio/status/2067202108303311255) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Результат:**

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Объект в сплите: чертеж и рендер"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Объект в сплите: чертеж и рендер"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Объект в сплите: чертеж и рендер"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Объект в сплите: чертеж и рендер"></a></td></tr>
</table>
...
### Case 107: [Пергола в сплите: чертеж и готовая постройка](https://x.com/iamaiistudio/status/2067142493389603170) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Результат:**

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Пергола в сплите: чертеж и готовая постройка"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Пергола в сплите: чертеж и готовая постройка"></a></td></tr>
</table>
...
Мы рады вкладу сообщества. Если вы создали или нашли сильный промпт для GPT-Image-2, поделитесь им с другими участниками.

### Способы внести вклад

Отправить промпт через Issue: используйте наш [шаблон отправки промпта](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml), чтобы приложить промпт и выходные изображения.

Открыть Pull Request: добавьте свой кейс напрямую в подходящий файл `cases/*.md`, соблюдая существующий формат.

Сообщить о проблеме: нашли битую ссылку или некорректный промпт? [Откройте issue](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new).

**Правила отправки:**
- Укажите полный переиспользуемый текст промпта, а не только описание
- Прикрепите или укажите ссылку минимум на одно выходное изображение
- Укажите категорию, к которой относится промпт
- Укажите оригинального автора, если делитесь чужой работой

Подробные правила смотрите в [CONTRIBUTING.md](contributing.md).

## 🙏 Благодарности

Этот репозиторий вдохновлен сильными открытыми коллекциями промптов и экспериментами GPT-Image-2, которыми сообщество делится публично.

Спасибо авторам и контрибьюторам, которые открыто делятся своими работами и сделали эти кейсы возможными.
...
> Мы не можем гарантировать, что каждый кейс всегда указан с самым первым оригинальным автором. Если что-то нужно исправить, свяжитесь с нами, и мы обновим атрибуцию.

Если у вас есть другие интересные кейсы промптов GPT-Image-2, напишите нам и помогите расширить библиотеку промптов Evolink.

## ⭐ История звезд

[![График истории звезд](https://api.star-history.com/svg?repos=EvoLinkAI/awesome-gpt-image-2-API-and-Prompts&type=Date)](https://www.star-history.com/#EvoLinkAI/awesome-gpt-image-2-API-and-Prompts&Date)
