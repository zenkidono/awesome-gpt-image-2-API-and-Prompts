...
> **12 curated cases** — [Explore all Character Design Prompts →](cases/character.md)
...
> **39 curated cases** — [Explore all UI & Social Media Mockup Prompts →](cases/ui.md)
...
| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ui_case187/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - The King Still Breathes Masthead"></a> |
...
> **26 curated cases** — [Explore all Comparison & Community Examples →](cases/comparison.md)
