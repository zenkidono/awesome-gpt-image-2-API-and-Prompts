...
- [❓ O que é GPT Image 2?](#-o-que-é-gpt-image-2)
- [📰 Novidades](#-novidades)
- [🔌 Usar a API GPT Image 2](#-usar-a-api-gpt-image-2)
- [🛒 Casos de e-commerce](#-e-commerce-cases)
- [📣 Casos de criativos publicitários](#-ad-creative-cases)
- [🍌 Casos de retrato e fotografia](#-portrait--photography-cases)
- [🎨 Casos de pôster e ilustração](#-poster--illustration-cases)
- [🧍 Casos de design de personagem](#-character-design-cases)
- [📱 Casos de UI e mockups para redes sociais](#-ui--social-media-mockup-cases)
- [🧪 Comparações e exemplos da comunidade](#-comparison--community-examples)
...
- 🎯 Prompts prontos para produção em 7 categorias (retrato, pôster, UI, e-commerce, criativo publicitário, design de personagem, comparação)
- 🔌 Guias de integração da API GPT Image 2 e skills chamáveis
- 🌍 Documentação completa em 11 idiomas
- 📸 Imagens reais de saída para cada caso de prompt

Experimente na Evolink: [API GPT-Image-2](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
**GPT Image 2** (também conhecido como GPT-Image-2 ou gpt-image-2) é o modelo de geração e edição de imagens da OpenAI, integrado nativamente ao ChatGPT e disponível pela API da OpenAI.

**Principais capacidades:**
**Geração text-to-image** — criar imagens fotorrealistas, ilustrações, pôsteres, mockups de UI e outros visuais a partir de prompts em linguagem natural
**Edição de imagem** — modificar imagens existentes com instruções em texto (inpainting, outpainting, transferência de estilo)
**Conversas em múltiplas etapas** — refinar imagens progressivamente por meio de diálogo
**Renderização fiel de texto** — gerar texto legível e preciso dentro das imagens
**Consistência de personagem** — manter a identidade de um personagem em várias gerações

**Por que desenvolvedores usam a API GPT Image 2:**
Uma única chamada de API para geração e edição
Melhor aderência ao prompt em comparação com modelos anteriores
Suporte nativo a proporções, transparência e geração em lote
Compatibilidade com o formato padrão da API da OpenAI (`/v1/images/generations`)
...
**18 de junho de 2026:** Adicionados 8 novos casos de prompts GPT-Image-2 (2 retratos, 2 pôsteres, 2 criativos publicitários, 1 e-commerce, 1 UI) a partir do loop de atualização de prompts de imagem após revisão semântica e validação de mídia

**15 de junho de 2026:** Adicionados 9 novos casos de prompts GPT-Image-2 (4 criativos publicitários, 3 pôsteres, 1 retrato, 1 UI) a partir do loop de atualização de prompts de imagem após revisão semântica e validação de mídia

**14 de junho de 2026:** Adicionados 14 novos casos de prompts GPT-Image-2 (9 pôsteres, 2 criativos publicitários, 1 personagem, 1 UI, 1 comparação) a partir do loop de atualização de prompts de imagem após revisão semântica e validação de mídia

**12 de junho de 2026:** Adicionados 42 novos casos de prompts GPT-Image-2 (19 retratos, 12 pôsteres, 4 criativos publicitários, 4 personagens, 2 comparações, 1 e-commerce) do lote diário de curadoria após aprovação e validação de mídia; 2 candidatos aprovados foram ignorados porque a busca do tweet não retornou mídia utilizável
...
**7 de junho de 2026:** Adicionados 19 novos casos de prompts GPT-Image-2 (2 retrato, 6 pôster, 5 UI, 4 e-commerce, 2 comparação) do lote diário após revisão e validação de mídia

**27 de maio de 2026:** Adicionados 6 novos casos de prompts GPT-Image-2 (1 retrato, 3 pôster, 1 UI, 1 comparação) do lote diário de curadoria após revisão e validação de mídia

**19 de maio de 2026:** Adicionados 23 novos casos de prompts GPT-Image-2 (13 retrato, 8 pôster, 2 UI) do lote de curadoria diária


- **12 de maio de 2026:** Adicionados 12 novos casos de prompts GPT-Image-2 (2 retrato, 9 pôster, 1 UI) do lote de curadoria diária

- **11 de maio de 2026:** Adicionados 16 novos casos de prompts GPT-Image-2 (5 retrato, 8 pôster, 3 criativo publicitário) do lote de curadoria diária

- **10 de maio de 2026:** Adicionados 19 novos casos de prompts GPT-Image-2 (4 retrato, 11 pôster, 3 UI, 1 comparação) do lote de curadoria diária
...
- **6 de maio de 2026:** Adicionados 7 novos casos de prompts GPT-Image-2 (2 retrato, 5 pôster)
- **5 de maio de 2026:** Adicionados 12 novos casos de prompts GPT-Image-2 (4 retrato, 5 pôster, 3 UI)
- **3 de maio de 2026:** Adicionados 10 novos casos de prompts GPT-Image-2 (1 e-commerce, 1 publicidade, 3 retrato, 2 pôster, 3 UI)

<details>
<summary>📜 Atualizações anteriores</summary>

- **2 de maio de 2026:** Adicionados 18 novos casos (3 retrato, 7 pôster, 4 UI, 4 comparação)
- **30 de abril de 2026:** Adicionados 9 novos casos (3 retrato, 1 pôster, 3 UI, 2 comparação)
- **29 de abril de 2026:** Adicionados 22 novos casos (3 e-commerce, 3 publicidade, 4 retrato, 2 personagens, 9 pôster, 1 comparação)
- **18 de abril de 2026:** Primeira publicação do repositório com conjunto curado de casos GPT-Image-2

</details>

## 🔌 Usar a API GPT Image 2

Quer sair rapidamente da inspiração de prompt para a geração real de imagens? Use a documentação da API GPT Image 2 junto com o skill chamável.

### 1. Instalação rápida do skill

- [Acesse o repositório gpt-image-2-gen-skill](https://github.com/EvoLinkAI/gpt-image-2-gen-skill)
...
- [Obtenha sua chave de API](https://evolink.ai/dashboard?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
- Leia a documentação da API GPT Image 2
...
👉 **[Veja os 20 casos de prompts de e-commerce →](cases/ecommerce.md)**
...
<!-- Case 173: Foto de produto de sérum floral (by @iamaiistudio) -->
### Case 173: [Foto de produto de sérum floral](https://x.com/iamaiistudio/status/2067413876564795743) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Foto de produto de sérum floral"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Foto de produto de sérum floral"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Foto de produto de sérum floral"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Foto de produto de sérum floral"></a></td></tr>
</table>
...
<!-- Case 174: Anúncio de sorvete com destaque dos ingredientes (by @iamaiistudio) -->
### Case 174: [Anúncio de sorvete com destaque dos ingredientes](https://x.com/iamaiistudio/status/2067465624683700642) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
👉 **Veja os 19 casos de prompts de criativos publicitários →**
...
<!-- Case 188: Grade editorial de tênis de luxo (by @iamaiistudio) -->
### Case 188: [Grade editorial de tênis de luxo](https://x.com/iamaiistudio/status/2065964253505585436) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 189: Anúncio lifestyle de fones sem fio (by @iamaiistudio) -->
### Case 189: [Anúncio lifestyle de fones sem fio](https://x.com/iamaiistudio/status/2065753093283991651) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 190: Cena da Poltrona Balanço Kinder Joy (by @iamaiistudio) -->
### Case 190: [Cena da Poltrona Balanço Kinder Joy](https://x.com/iamaiistudio/status/2066312771978092587) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case190/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Cena da Poltrona Balanço Kinder Joy"></a> |
...
<!-- Case 191: Anúncio de Protetor Solar Escudo Invisível (by @iamrealsnow) -->
### Case 191: [Anúncio de Protetor Solar Escudo Invisível](https://x.com/iamrealsnow/status/2066200217347854445) (by [@iamrealsnow](https://x.com/iamrealsnow))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Anúncio de Protetor Solar Escudo Invisível"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Anúncio de Protetor Solar Escudo Invisível"></a></td></tr>
</table>
...
<!-- Case 192: Ilusão de Paisagem com Logo Oculto (by @iamaiistudio) -->
### Case 192: [Ilusão de Paisagem com Logo Oculto](https://x.com/iamaiistudio/status/2066191259354689714) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Ilusão de Paisagem com Logo Oculto"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Ilusão de Paisagem com Logo Oculto"></a></td></tr>
</table>
...
<!-- Case 193: Pôster de Moda com Logo Líquido SPLASH (by @iamaiistudio) -->
### Case 193: [Pôster de Moda com Logo Líquido SPLASH](https://x.com/iamaiistudio/status/2065979523229975021) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case193/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Pôster de Moda com Logo Líquido SPLASH"></a> |
...
<!-- Case 194: Campanha de Marca de Café OBSIDIAN (by @iamaiistudio) -->
### Case 194: [Campanha de Marca de Café OBSIDIAN](https://x.com/iamaiistudio/status/2066523210808484228) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

| Resultado |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case194/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Campanha de Marca de Café OBSIDIAN"></a> |
...
<!-- Case 195: Anúncio skincare Coconut Paradise (by @Strength04_X) -->
### Case 195: [Anúncio skincare Coconut Paradise](https://x.com/Strength04_X/status/2067445760325734734) (by [@Strength04_X](https://x.com/Strength04_X))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case195/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Anúncio skincare Coconut Paradise"></a> |
...
<!-- Case 196: VFX de produto em remontagem reversa (by @iamaiistudio) -->
### Case 196: [VFX de produto em remontagem reversa](https://x.com/iamaiistudio/status/2067399156596175345) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX de produto em remontagem reversa"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX de produto em remontagem reversa"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX de produto em remontagem reversa"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - VFX de produto em remontagem reversa"></a></td></tr>
</table>
...
<!-- Case 197: Foto de produto de lata com revelação de uvas (by @iamaiistudio) -->
### Case 197: [Foto de produto de lata com revelação de uvas](https://x.com/iamaiistudio/status/2067750180724855280) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case197/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Grape Reveal Can Product Shot"></a> |
...
👉 **Veja os 68 casos de prompts de retrato e fotografia →**
...
<!-- Case 304: Miniatura de Lã Feltrada com Agulha (by @iamaiistudio) -->
### Case 304: [Miniatura de Lã Feltrada com Agulha](https://x.com/iamaiistudio/status/2066206049464660301) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case304/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Miniatura de Lã Feltrada com Agulha"></a> |
...
<!-- Case 305: Retrato Japonês Arejado à Janela (by @iamaiistudio) -->
### Case 305: [Retrato Japonês Arejado à Janela](https://x.com/iamaiistudio/status/2066643592366727581) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

| Resultado |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case305/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Retrato Japonês Arejado à Janela"></a> |
...
<!-- Case 306: Retrato com café gelado no banco (by @saniaspeaks_) -->
### Case 306: [Retrato com café gelado no banco](https://x.com/saniaspeaks_/status/2067451160991084677) (by [@saniaspeaks_](https://x.com/saniaspeaks_))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Retrato com café gelado no banco"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Retrato com café gelado no banco"></a></td></tr>
</table>
...
<!-- Case 307: Retrato em close com curtain bangs (by @iamsofiaijaz) -->
### Case 307: [Retrato em close com curtain bangs](https://x.com/iamsofiaijaz/status/2067450336378544407) (by [@iamsofiaijaz](https://x.com/iamsofiaijaz))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case307/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Retrato em close com curtain bangs"></a> |
...
<!-- Case 308: Close-up de prótese ciborgue (by @iamaiistudio) -->
### Case 308: [Close-up de prótese ciborgue](https://x.com/iamaiistudio/status/2067732972351222060) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 309: Retrato ensolarado em viela mediterrânea (by @iamaiistudio) -->
### Case 309: [Retrato ensolarado em viela mediterrânea](https://x.com/iamaiistudio/status/2067474399431979223) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
👉 **Veja os 119 casos de prompts de pôster e ilustração →**
...
<!-- Case 394: Diagrama explodido da Sony A7 (by @iamaiistudio) -->
### Case 394: [Diagrama explodido da Sony A7](https://x.com/iamaiistudio/status/2066085004116193571) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 395: Render de produto de órgão biomecânico (by @iamaiistudio) -->
### Case 395: [Render de produto de órgão biomecânico](https://x.com/iamaiistudio/status/2066069842407416126) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 396: Pôster WPA sobre tempestades solares (by @92digitalartArt) -->
### Case 396: [Pôster WPA sobre tempestades solares](https://x.com/92digitalartArt/status/2066062156441735187) (by [@92digitalartArt](https://x.com/92digitalartArt))
...
<!-- Case 397: Pôster automotivo premium com especificações (by @iamaiistudio) -->
### Case 397: [Pôster automotivo premium com especificações](https://x.com/iamaiistudio/status/2066055530012111310) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 398: Pôster urbano 3D dopamina (by @iamaiistudio) -->
### Case 398: [Pôster urbano 3D dopamina](https://x.com/iamaiistudio/status/2066039955177234472) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 399: Pôster publicitário profissional quadrado (by @iamaiistudio) -->
### Case 399: [Pôster publicitário profissional quadrado](https://x.com/iamaiistudio/status/2066024623637188813) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 400: Cena de filme de ação blockbuster (by @iamaiistudio) -->
### Case 400: [Cena de filme de ação blockbuster](https://x.com/iamaiistudio/status/2066009564018082289) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 401: Modelo de ilustração editorial em tinta (by @Naiknelofar788) -->
### Case 401: [Modelo de ilustração editorial em tinta](https://x.com/Naiknelofar788/status/2065973105823281314) (by [@Naiknelofar788](https://x.com/Naiknelofar788))
...
<!-- Case 402: Diorama isométrico de marco icônico (by @iamaiistudio) -->
### Case 402: [Diorama isométrico de marco icônico](https://x.com/iamaiistudio/status/2065737739589615987) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 403: Mundo em Miniatura de Dar Corda (by @Gdgtify) -->
### Case 403: [Mundo em Miniatura de Dar Corda](https://x.com/Gdgtify/status/2066192943887630372) (by [@Gdgtify](https://x.com/Gdgtify))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case403/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Mundo em Miniatura de Dar Corda"></a> |
...
<!-- Case 404: Cidade de Águas-Vivas Sobre as Dunas (by @92digitalartArt) -->
### Case 404: [Cidade de Águas-Vivas Sobre as Dunas](https://x.com/92digitalartArt/status/2066176419038683562) (by [@92digitalartArt](https://x.com/92digitalartArt))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case404/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Cidade de Águas-Vivas Sobre as Dunas"></a> |
...
<!-- Case 405: Pôster de Viagem com Mapa da Cidade em Tilt-Shift (by @iamaiistudio) -->
### Case 405: [Pôster de Viagem com Mapa da Cidade em Tilt-Shift](https://x.com/iamaiistudio/status/2066145999266128367) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pôster de Viagem com Mapa da Cidade em Tilt-Shift"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pôster de Viagem com Mapa da Cidade em Tilt-Shift"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pôster de Viagem com Mapa da Cidade em Tilt-Shift"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Pôster de Viagem com Mapa da Cidade em Tilt-Shift"></a></td></tr>
</table>
...
<!-- Case 406: Pôster de Evento do Bootcamp de Música com IA (by @iamaiistudio) -->
...
<!-- Case 407: Pôster editorial Stay Focused (by @iamaiistudio) -->
### Case 407: [Pôster editorial Stay Focused](https://x.com/iamaiistudio/status/2067444516605620410) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case407/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Pôster editorial Stay Focused"></a> |
...
<!-- Case 408: Infográfico de receita de chowmein (by @iamaiistudio) -->
### Case 408: [Infográfico de receita de chowmein](https://x.com/iamaiistudio/status/2067429181726904350) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case408/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Infográfico de receita de chowmein"></a> |
...
<!-- Case 409: Pôster editorial New Intelligence (by @iamaiistudio) -->
### Case 409: [Pôster editorial New Intelligence](https://x.com/iamaiistudio/status/2067778187644584418) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/poster_case409/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - New Intelligence Editorial Poster"></a> |
...
👉 **Veja os 14 casos de prompts de design de personagem →**
...
<!-- Case 23: Modelo de retrato cartoon surreal (by @Goodmanprotocol) -->
### Case 23: [Modelo de retrato cartoon surreal](https://x.com/Goodmanprotocol/status/2066048157805629937) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))
...
<!-- Case 24: Folha de Movimento de Dança Coreana (by @iamaiistudio) -->
### Case 24: [Folha de Movimento de Dança Coreana](https://x.com/iamaiistudio/status/2066659127485718574) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

| Resultado |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/character_case24/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Folha de Movimento de Dança Coreana"></a> |
...
<!-- Case 25: Pôster de Personagem da Arquivista Luminant (by @92digitalartArt) -->
### Case 25: [Pôster de Personagem da Arquivista Luminant](https://x.com/92digitalartArt/status/2066558474650095890) (by [@92digitalartArt](https://x.com/92digitalartArt))

**Resultado:**

| Resultado |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/character_case25/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Pôster de Personagem da Arquivista Luminant"></a> |
...
### Case 26: [Perfil de Personagem de Visual Novel](https://x.com/iamaiistudio/status/2067308176715001944) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

| Resultado |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/character_case26/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Perfil de Personagem de Visual Novel"></a> |
...
<!-- Case 27: Ficha de personagem do alquimista medieval (by @itsPixieVerse) -->
### Case 27: [Ficha de personagem do alquimista medieval](https://x.com/itsPixieVerse/status/2067750004178215241) (by [@itsPixieVerse](https://x.com/itsPixieVerse))
...
👉 **Veja os 67 casos de prompts de UI e mockups para redes sociais →**
...
<!-- Case 183: Página de portfólio estilo internet antiga (by @Kashberg_0) -->
### Case 183: [Página de portfólio estilo internet antiga](https://x.com/Kashberg_0/status/2065992579502747850) (by [@Kashberg_0](https://x.com/Kashberg_0))
...
<!-- Case 184: Transformação de Foto em Lápis de Cor (by @AIwithSynthia) -->
### Case 184: [Transformação de Foto em Lápis de Cor](https://x.com/AIwithSynthia/status/2066154697828782245) (by [@AIwithSynthia](https://x.com/AIwithSynthia))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case184/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Transformação de Foto em Lápis de Cor"></a> |
...
<!-- Case 185: Folha de Identidade de Marca com Mascote (by @iamaiistudio) -->
### Case 185: [Folha de Identidade de Marca com Mascote](https://x.com/iamaiistudio/status/2066568983453880412) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

| Resultado |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case185/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Folha de Identidade de Marca com Mascote"></a> |
...
<!-- Case 186: Página de Catálogo de Produto Arquitetônico (by @iamaiistudio) -->
### Case 186: [Página de Catálogo de Produto Arquitetônico](https://x.com/iamaiistudio/status/2066447564132745574) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

| Resultado |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case186/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Página de Catálogo de Produto Arquitetônico"></a> |
...
<!-- Case 187: Masthead The King Still Breathes (by @NeuralAIInsight) -->
...
> **26 casos selecionados** — [Explorar todos os exemplos de comparação →](cases/comparison.md)
...
👉 **Veja os 55 casos de prompts de comparação e exemplos da comunidade →**
...
<!-- Case 105: Teste de edição de cálculo com moedas (by @iamaiistudio) -->
### Case 105: [Teste de edição de cálculo com moedas](https://x.com/iamaiistudio/status/2065994787094983151) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 106: [Objeto Dividido entre Blueprint e Render](https://x.com/iamaiistudio/status/2067202108303311255) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objeto Dividido entre Blueprint e Render"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objeto Dividido entre Blueprint e Render"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objeto Dividido entre Blueprint e Render"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Objeto Dividido entre Blueprint e Render"></a></td></tr>
</table>
...
### Case 107: [Divisão entre Blueprint e Construção de Pérgola](https://x.com/iamaiistudio/status/2067142493389603170) (by [@iamaiistudio](https://x.com/iamaiistudio))

**Resultado:**

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Divisão entre Blueprint e Construção de Pérgola"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - Divisão entre Blueprint e Construção de Pérgola"></a></td></tr>
</table>
...
Contribuições da comunidade são muito bem-vindas! Se você criou ou encontrou um ótimo prompt GPT-Image-2, compartilhe com a comunidade.

### Formas de contribuir

Enviar um prompt por Issue: use nosso [modelo de envio de prompt](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml) para enviar seu prompt com imagens de saída.

Abrir uma Pull Request: adicione seu caso diretamente ao arquivo `cases/*.md` apropriado seguindo o formato existente.

Reportar problemas: encontrou um link quebrado, prompt incorreto ou atribuição que precisa de ajuste? [Abra uma issue](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new).

**Diretrizes de envio:**
- Inclua o texto completo e reutilizável do prompt, não apenas uma descrição
- Anexe ou vincule pelo menos uma imagem de saída
- Especifique a categoria à qual o prompt pertence
- Dê crédito ao autor original se estiver compartilhando o trabalho de outra pessoa

Veja [CONTRIBUTING.md](contributing.md) para diretrizes detalhadas.

## Agradecimentos

Este repositório foi inspirado por excelentes coleções abertas de prompts e experimentos GPT-Image-2 compartilhados pela comunidade.
...
Se você tiver outros casos interessantes de prompts GPT-Image-2 para compartilhar, entre em contato e ajude-nos a expandir a biblioteca de prompts da Evolink.
