...
- [🍌 はじめに](#-はじめに)
- [❓ GPT Image 2 とは](#-gpt-image-2-とは)
- [📰 ニュース](#-ニュース)
- [🔌 GPT Image 2 API を使う](#-gpt-image-2-api-を使う)
- [🛒 Eコマース事例](#-eコマース事例)
- [📣 広告クリエイティブ事例](#-広告クリエイティブ事例)
- [🍌 ポートレート・写真事例](#-ポートレート写真事例)
- [🎨 ポスター・イラスト事例](#-ポスターイラスト事例)
- [🧍 キャラクターデザイン事例](#-キャラクターデザイン事例)
- [📱 UI・ソーシャルメディアモックアップ事例](#-uiソーシャルメディアモックアップ事例)
...
**Awesome GPT Image 2 API and Prompts** リポジトリへようこそ！🤗

AI 画像生成向けに、**862件以上の高品質な GPT-Image-2 プロンプト**、API 活用パターン、再利用しやすいビジュアルワークフローを厳選してまとめています。

GPT-Image-2 のプロンプト例、text-to-image のベストプラクティス、画像編集テクニック、すぐに使えるプロンプトテンプレートを探している方のためのリファレンスです。

**このリポジトリで見つかるもの:**
- 🎯 7カテゴリ（ポートレート、ポスター、UI、Eコマース、広告クリエイティブ、キャラクターデザイン、比較）にわたる本番利用しやすいプロンプト
- 🔌 GPT Image 2 API の連携ガイドと呼び出し可能な skill
- 🌍 11言語対応のドキュメント
- 📸 すべてのプロンプトケースに対応した実際の出力画像

Evolink で試す: [GPT-Image-2 API](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)

役に立ったら、ぜひスターを付けてください。⭐
...
**GPT Image 2**（GPT-Image-2 / gpt-image-2 とも表記）は、ChatGPT にネイティブ統合され、OpenAI API からも利用できる OpenAI の画像生成・編集モデルです。

**主な機能:**
**Text-to-image 生成** — 自然言語プロンプトから、写実的な画像、イラスト、ポスター、UI モックアップなどを作成
**画像編集** — テキスト指示で既存画像を編集（インペインティング、アウトペインティング、スタイル変換）
**マルチターン対話** — 会話を通じて画像を段階的に改善
**高精度な文字描画** — 生成画像内の文字をより正確にレンダリング
**一貫したキャラクター生成** — 複数生成でもキャラクターの同一性を維持

**開発者が GPT Image 2 API を使う理由:**
生成と編集を1つの API 呼び出しで扱える
従来モデルよりプロンプト追従性が高い
アスペクト比、透過、バッチ生成をネイティブにサポート
OpenAI の標準 API 形式（`/v1/images/generations`）で利用可能

> API の使い方は、下の「GPT Image 2 API を使う」セクションで詳しく確認できます。

## 📰 ニュース

**2026年6月18日：** デイリー画像プロンプト更新ループから GPT-Image-2 の新規プロンプト事例 8 件（ポートレート 2、ポスター 2、広告クリエイティブ 2、E-commerce 1、UI 1）を追加。意味レビューとメディア検証を完了

**2026年6月18日:** セマンティックレビューとメディア検証を通過した画像プロンプト更新ループから、GPT-Image-2 の新規プロンプトケースを8件追加（ポートレート2件、ポスター2件、Eコマース1件、広告クリエイティブ2件、UI 1件）
...
**2026年6月12日:** 承認とメディア検証を経たデイリーキュレーションバッチから、GPT-Image-2 の新規プロンプトケースを42件追加（ポートレート19件、ポスター12件、広告クリエイティブ4件、キャラクター4件、比較2件、Eコマース1件）。承認済み候補のうち2件は、ツイート検索で利用可能なメディアが見つからなかったためスキップしました

**2026年6月10日：** デイリーキュレーションバッチから31件の新しいGPT-Image-2プロンプトケースを追加（肖像9件、ポスター21件、比較1件）、レビューおよびメディア検証完了

**2026年6月9日：** デイリーキュレーションバッチから12件の新しいGPT-Image-2プロンプトケースを追加しました（ポートレート2件、ポスター7件、比較2件、Eコマース1件）

**2026年6月8日:** デイリーキュレーション承認バッチから GPT-Image-2 の新規プロンプト事例を24件追加（ポートレート5、ポスター7、UI 5、E-commerce 3、比較4）。スレッド復元とメディア検証を完了
...
**2026年5月27日:** デイリーキュレーションバッチから6件の新しいGPT-Image-2プロンプトケースを追加（ポートレート1件、ポスター3件、UI 1件、比較1件）。レビューとメディア検証済み

**2026年5月19日:** 毎日のキュレーションバッチから23件の新しいGPT-Image-2プロンプトケースを追加（ポートレート13件、ポスター8件、UI 2件）



- **2026年5月12日:** デイリーキュレーションバッチから12件の新しいGPT-Image-2プロンプトケースを追加（ポートレート2件、ポスター9件、UI 1件）

- **2026年5月11日:** デイリーキュレーションバッチから16件の新しいGPT-Image-2プロンプトケースを追加（ポートレート5件、ポスター8件、広告クリエイティブ3件）

- **2026年5月10日:** デイリーキュレーションバッチから19件の新しいGPT-Image-2プロンプトケースを追加（ポートレート4件、ポスター11件、UI 3件、比較1件）

- **2026年5月9日:** デイリーキュレーションバッチから19件の新しいGPT-Image-2プロンプトケースを追加（ポートレート6件、ポスター12件、比較1件）
...
- **2026年5月3日:** 10 件の新しい GPT-Image-2 プロンプトケースを追加(Eコマース 1、広告 1、ポートレート 3、ポスター 2、UI 3)

<details>
<summary>📜 過去の更新</summary>

- **2026年5月2日:** 18 件の新しいケースを追加(ポートレート 3、ポスター 7、UI 4、比較 4)
- **2026年4月30日:** 9 件の新しいケースを追加(ポートレート 3、ポスター 1、UI 3、比較 2)
- **2026年4月29日:** 22 件の新しいケースを追加(Eコマース 3、広告 3、ポートレート 4、キャラクター 2、ポスター 9、比較 1)
- **2026年4月18日:** GPT-Image-2 厳選ケースセットでリポジトリを最初に公開

</details>

## 🔌 GPT Image 2 API を使う

プロンプトのインスピレーションから実際の画像生成まで素早く進めたい場合は、GPT Image 2 API ドキュメントと呼び出し可能な skill をあわせて利用できます。

### 1. Skill をクイックインストール

- [gpt-image-2-gen-skill リポジトリを開く](https://github.com/EvoLinkAI/gpt-image-2-gen-skill)
- 1 行でインストール:
...
- [API キーを取得](https://evolink.ai/dashboard?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
- GPT Image 2 API ドキュメントを読む
...
👉 **[すべての Eコマースプロンプト事例を見る →](cases/ecommerce.md)**
...
<!-- Case 173: フローラルセラム商品カット (by @iamaiistudio) -->
### Case 173: [フローラルセラム商品カット](https://x.com/iamaiistudio/status/2067413876564795743) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - フローラルセラム商品カット"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - フローラルセラム商品カット"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - フローラルセラム商品カット"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - フローラルセラム商品カット"></a></td></tr>
</table>
...
> **26件の厳選ケース** — [すべての広告クリエイティブプロンプトを見る →](cases/ad-creative.md)
...
### Case 188: [ラグジュアリースニーカー編集グリッド](https://x.com/iamaiistudio/status/2065964253505585436) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 189: [ワイヤレスイヤホンのライフスタイル広告](https://x.com/iamaiistudio/status/2065753093283991651) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 194: OBSIDIAN コーヒーブランドキャンペーン (by @iamaiistudio) -->
### Case 194: [OBSIDIAN コーヒーブランドキャンペーン](https://x.com/iamaiistudio/status/2066523210808484228) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 195: Coconut Paradise スキンケア広告 (by @Strength04_X) -->
### Case 195: [Coconut Paradise スキンケア広告](https://x.com/Strength04_X/status/2067445760325734734) (by [@Strength04_X](https://x.com/Strength04_X))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case195/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Coconut Paradise スキンケア広告"></a> |
...
<!-- Case 196: 逆再構成プロダクトVFX (by @iamaiistudio) -->
### Case 196: [逆再構成プロダクトVFX](https://x.com/iamaiistudio/status/2067399156596175345) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 逆再構成プロダクトVFX"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 逆再構成プロダクトVFX"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 逆再構成プロダクトVFX"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ad-creative_case196/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 逆再構成プロダクトVFX"></a></td></tr>
</table>
...
> **128件の厳選ケース** — [すべてのポートレートプロンプトを見る →](cases/portrait.md)
...
<!-- Case 305: 軽やかな和窓ポートレート (by @iamaiistudio) -->
### Case 305: [軽やかな和窓ポートレート](https://x.com/iamaiistudio/status/2066643592366727581) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 306: ベンチのアイスコーヒーポートレート (by @saniaspeaks_) -->
### Case 306: [ベンチのアイスコーヒーポートレート](https://x.com/saniaspeaks_/status/2067451160991084677) (by [@saniaspeaks_](https://x.com/saniaspeaks_))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - ベンチのアイスコーヒーポートレート"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - ベンチのアイスコーヒーポートレート"></a></td></tr>
</table>
...
<!-- Case 307: カーテンバングのクローズアップポートレート (by @iamsofiaijaz) -->
### Case 307: [カーテンバングのクローズアップポートレート](https://x.com/iamsofiaijaz/status/2067450336378544407) (by [@iamsofiaijaz](https://x.com/iamsofiaijaz))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case307/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - カーテンバングのクローズアップポートレート"></a> |
...
> **147件の厳選ケース** — [すべてのポスタープロンプトを見る →](cases/poster.md)
...
### Case 394: [Sony A7 分解図](https://x.com/iamaiistudio/status/2066085004116193571) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 395: [バイオメカニカル臓器プロダクトレンダー](https://x.com/iamaiistudio/status/2066069842407416126) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 396: [太陽嵐 WPA ポスター](https://x.com/92digitalartArt/status/2066062156441735187) (by [@92digitalartArt](https://x.com/92digitalartArt))
...
### Case 397: [プレミアム自動車スペックポスター](https://x.com/iamaiistudio/status/2066055530012111310) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 398: [ドーパミン 3D アーバンポスター](https://x.com/iamaiistudio/status/2066039955177234472) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 399: [正方形プロ向け広告ポスター](https://x.com/iamaiistudio/status/2066024623637188813) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 400: [大作アクション映画風ショット](https://x.com/iamaiistudio/status/2066009564018082289) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 401: [エディトリアルインクイラストテンプレート](https://x.com/Naiknelofar788/status/2065973105823281314) (by [@Naiknelofar788](https://x.com/Naiknelofar788))
...
### Case 402: [アイソメトリックランドマークジオラマ](https://x.com/iamaiistudio/status/2065737739589615987) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 406: AI音楽ブートキャンプイベントポスター (by @iamaiistudio) -->
...
### Case 23: [シュールなカートゥーン肖像テンプレート](https://x.com/Goodmanprotocol/status/2066048157805629937) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))
...
---
<!-- Case 24: 韓国ダンスのモーションシート (by @iamaiistudio) -->
### Case 24: [韓国ダンスのモーションシート](https://x.com/iamaiistudio/status/2066659127485718574) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
---
<!-- Case 25: ルミナント・アーキビストのキャラクターポスター (by @92digitalartArt) -->
### Case 25: [ルミナント・アーキビストのキャラクターポスター](https://x.com/92digitalartArt/status/2066558474650095890) (by [@92digitalartArt](https://x.com/92digitalartArt))
...
<!-- Case 26: ビジュアルノベル キャラクタープロフィール (by @iamaiistudio) -->
### Case 26: [ビジュアルノベル キャラクタープロフィール](https://x.com/iamaiistudio/status/2067308176715001944) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
> **40件の厳選ケース** — [すべての UI・モックアッププロンプトを見る →](cases/ui.md)
...
### Case 183: [初期インターネット風ポートフォリオページ](https://x.com/Kashberg_0/status/2065992579502747850) (by [@Kashberg_0](https://x.com/Kashberg_0))
...
<!-- Case 185: マスコットのブランドアイデンティティシート (by @iamaiistudio) -->
### Case 185: [マスコットのブランドアイデンティティシート](https://x.com/iamaiistudio/status/2066568983453880412) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 186: 建築的プロダクトカタログページ (by @iamaiistudio) -->
### Case 186: [建築的プロダクトカタログページ](https://x.com/iamaiistudio/status/2066447564132745574) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 187: The King Still Breathes マストヘッド (by @NeuralAIInsight) -->
### Case 187: [The King Still Breathes マストヘッド](https://x.com/NeuralAIInsight/status/2067291988953567706) (by [@NeuralAIInsight](https://x.com/NeuralAIInsight))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ui_case187/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - The King Still Breathes マストヘッド"></a> |
...
> **26件の厳選ケース** — [すべての比較事例を見る →](cases/comparison.md)
...
### Case 105: [硬貨合計編集テスト](https://x.com/iamaiistudio/status/2065994787094983151) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 106: ブループリントとレンダーの分割オブジェクト (by @iamaiistudio) -->
### Case 106: [ブループリントとレンダーの分割オブジェクト](https://x.com/iamaiistudio/status/2067202108303311255) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 107: パーゴラの設計図と完成形の分割比較 (by @iamaiistudio) -->
### Case 107: [パーゴラの設計図と完成形の分割比較](https://x.com/iamaiistudio/status/2067142493389603170) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
コミュニティからの貢献を歓迎します。優れた GPT-Image-2 プロンプトを作成または発見した場合は、ぜひコミュニティに共有してください。

### 貢献の方法

Issue からプロンプトを投稿: [Prompt Submission Template](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml) を使って、出力画像付きでプロンプトを投稿できます。

Pull Request を作成: 既存フォーマットに沿って、該当する `cases/*.md` ファイルにケースを直接追加してください。

問題を報告: リンク切れや誤ったプロンプトを見つけた場合は、[Issue を作成](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new)してください。

**投稿ガイドライン:**
- 説明だけでなく、再利用可能な完全なプロンプト本文を含める
- 少なくとも1枚の出力画像を添付またはリンクする
- プロンプトが属するカテゴリを明記する
- 他の作者の作品を共有する場合は、元の作者をクレジットする

詳しいガイドラインは [CONTRIBUTING.md](contributing.md) を参照してください。

## 🙏 謝辞

このリポジトリは、優れたオープンなプロンプトコレクションと、コミュニティで共有された GPT-Image-2 の実験に着想を得ています。

作品を公開し、これらのケーススタディを可能にしてくれたクリエイターとコントリビューターの皆さまに感謝します。
...
> すべてのケースが元の作者に正しく帰属していることを保証するものではありません。修正が必要な点があればご連絡ください。確認のうえ更新します。

共有したい面白い GPT-Image-2 プロンプト事例があれば、ぜひご連絡ください。Evolink のプロンプトライブラリ拡充にご協力いただけます。
