...
精選收錄 **889+ 個高品質 GPT-Image-2 提示詞**、API 使用模式與可重用視覺工作流，面向 AI 圖像生成實作。

無論你想找 GPT-Image-2 提示詞範例、文生圖最佳實作、圖像編輯技巧，還是可直接重用的 prompt 模板，這裡都可以作為你的參考入口。

**這裡包含：**
- 🎯 覆蓋 7 個類別的可生產使用提示詞（人像、海報、UI、電商、廣告創意、角色設計、對比）
- 🔌 GPT Image 2 API 整合指南與可呼叫 skill
- 🌍 11 種語言的完整文件
- 📸 每個 prompt 案例對應的真實輸出圖

在 Evolink 上試用：[GPT-Image-2 API](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
**GPT Image 2**（也寫作 GPT-Image-2 或 gpt-image-2）是 OpenAI 的圖像生成與編輯模型，已原生整合到 ChatGPT，也可透過 OpenAI API 使用。

**核心能力：**
**文生圖生成** — 透過自然語言提示詞生成寫實圖像、插畫、海報、UI mockup 等內容
**圖像編輯** — 用文字指令修改既有圖像，包括局部重繪、擴圖、風格遷移等
**多輪對話** — 透過連續對話逐步細化圖像結果
**高保真文字渲染** — 在生成圖像中更準確地呈現文字
**一致角色生成** — 在多次生成中保持角色身份與視覺一致性

**開發者為什麼使用 GPT Image 2 API：**
一次 API 呼叫即可覆蓋生成與編輯
相較上一代模型擁有更強的提示詞遵循能力
原生支援畫幅比例、透明背景與批次生成
...
**2026年6月18日：** 從圖片提示詞更新 loop 中新增 8 個 GPT-Image-2 提示詞案例（2 個人像、2 個海報、1 個電商、2 個廣告創意、1 個 UI），已完成語義審核與媒體校驗
...
- [前往 gpt-image-2-gen-skill 倉庫](https://github.com/EvoLinkAI/gpt-image-2-gen-skill)
- 一行命令安裝：
...
<!-- Case 173: 花卉精華產品大片 (by @iamaiistudio) -->
### Case 173: [花卉精華產品大片](https://x.com/iamaiistudio/status/2067413876564795743) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 花卉精華產品大片"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 花卉精華產品大片"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 花卉精華產品大片"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case173/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 花卉精華產品大片"></a></td></tr>
</table>
...
<!-- Case 174: 冰淇淋配料標註廣告 (by @iamaiistudio) -->
### Case 174: [冰淇淋配料標註廣告](https://x.com/iamaiistudio/status/2067465624683700642) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ecommerce_case174/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 冰淇淋配料標註廣告"></a> |
...
> **30 個精選案例** — [瀏覽全部廣告創意提示詞 →](cases/ad-creative.md)
...
👉 **See all 21 Ad Creative prompt cases →**
...
<!-- Case 188: 奢華運動鞋編輯網格 (by @iamaiistudio) -->
### Case 188: [奢華運動鞋編輯網格](https://x.com/iamaiistudio/status/2065964253505585436) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 189: 無線耳機生活風格廣告 (by @iamaiistudio) -->
### Case 189: [無線耳機生活風格廣告](https://x.com/iamaiistudio/status/2065753093283991651) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 隱形護盾防曬廣告"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case191/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 隱形護盾防曬廣告"></a></td></tr>
</table>
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 隱藏 Logo 地景幻象"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ad-creative_case192/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 隱藏 Logo 地景幻象"></a></td></tr>
</table>
...
> **132 個精選案例** — [瀏覽全部人像與攝影提示詞 →](cases/portrait.md)
...
<!-- Case 306: 公園長椅冰咖啡人像 (by @saniaspeaks_) -->
### Case 306: [公園長椅冰咖啡人像](https://x.com/saniaspeaks_/status/2067451160991084677) (by [@saniaspeaks_](https://x.com/saniaspeaks_))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 公園長椅冰咖啡人像"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case306/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 公園長椅冰咖啡人像"></a></td></tr>
</table>
...
<!-- Case 307: 窗簾劉海近景人像 (by @iamsofiaijaz) -->
### Case 307: [窗簾劉海近景人像](https://x.com/iamsofiaijaz/status/2067450336378544407) (by [@iamsofiaijaz](https://x.com/iamsofiaijaz))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case307/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 窗簾劉海近景人像"></a> |
...
<!-- Case 308: 賽博義肢近景特寫 (by @iamaiistudio) -->
### Case 308: [賽博義肢近景特寫](https://x.com/iamaiistudio/status/2067732972351222060) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case308/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 賽博義肢近景特寫"></a> |
...
| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/portrait_case309/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 地中海小巷日照人像"></a> |
...
> **151 個精選案例** — [瀏覽全部海報提示詞 →](cases/poster.md)
...
<!-- Case 394: Sony A7 分解結構圖 (by @iamaiistudio) -->
### Case 394: [Sony A7 分解結構圖](https://x.com/iamaiistudio/status/2066085004116193571) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 395: 仿生機械器官產品渲染 (by @iamaiistudio) -->
### Case 395: [仿生機械器官產品渲染](https://x.com/iamaiistudio/status/2066069842407416126) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 396: 太陽風暴 WPA 海報 (by @92digitalartArt) -->
### Case 396: [太陽風暴 WPA 海報](https://x.com/92digitalartArt/status/2066062156441735187) (by [@92digitalartArt](https://x.com/92digitalartArt))
...
<!-- Case 397: 高級汽車規格海報 (by @iamaiistudio) -->
### Case 397: [高級汽車規格海報](https://x.com/iamaiistudio/status/2066055530012111310) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 398: 多巴胺 3D 城市海報 (by @iamaiistudio) -->
### Case 398: [多巴胺 3D 城市海報](https://x.com/iamaiistudio/status/2066039955177234472) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 399: 方形專業廣告海報 (by @iamaiistudio) -->
### Case 399: [方形專業廣告海報](https://x.com/iamaiistudio/status/2066024623637188813) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 400: 大片級動作電影鏡頭 (by @iamaiistudio) -->
### Case 400: [大片級動作電影鏡頭](https://x.com/iamaiistudio/status/2066009564018082289) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<!-- Case 401: 編輯風墨線插畫模板 (by @Naiknelofar788) -->
### Case 401: [編輯風墨線插畫模板](https://x.com/Naiknelofar788/status/2065973105823281314) (by [@Naiknelofar788](https://x.com/Naiknelofar788))
...
<!-- Case 402: 等距地標微縮場景 (by @iamaiistudio) -->
### Case 402: [等距地標微縮場景](https://x.com/iamaiistudio/status/2065737739589615987) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 移軸城市地圖旅行海報"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 移軸城市地圖旅行海報"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 移軸城市地圖旅行海報"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case405/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 移軸城市地圖旅行海報"></a></td></tr>
</table>
...
> **12 個精選案例** — [瀏覽全部角色設計提示詞 →](cases/character.md)
...
<!-- Case 23: 超現實卡通肖像模板 (by @Goodmanprotocol) -->
### Case 23: [超現實卡通肖像模板](https://x.com/Goodmanprotocol/status/2066048157805629937) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))
...
### Case 26: [視覺小說角色檔案頁](https://x.com/iamaiistudio/status/2067308176715001944) (by [@iamaiistudio](https://x.com/iamaiistudio))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/character_case26/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 視覺小說角色檔案頁"></a> |
...
<!-- Case 27: 中世紀鍊金術士角色設定頁 (by @itsPixieVerse) -->
### Case 27: [中世紀鍊金術士角色設定頁](https://x.com/itsPixieVerse/status/2067750004178215241) (by [@itsPixieVerse](https://x.com/itsPixieVerse))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/character_case27/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 中世紀鍊金術士角色設定頁"></a> |
...
> **42 個精選案例** — [瀏覽全部 UI 與社群媒體 Mockup 提示詞 →](cases/ui.md)
...
<!-- Case 183: 早期網際網路作品集頁面 (by @Kashberg_0) -->
### Case 183: [早期網際網路作品集頁面](https://x.com/Kashberg_0/status/2065992579502747850) (by [@Kashberg_0](https://x.com/Kashberg_0))
...
<!-- Case 184: 彩鉛照片轉繪 (by @AIwithSynthia) -->
### Case 184: [彩鉛照片轉繪](https://x.com/AIwithSynthia/status/2066154697828782245) (by [@AIwithSynthia](https://x.com/AIwithSynthia))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case184/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 彩鉛照片轉繪"></a> |
...
<!-- Case 187: 王者仍在呼吸題頭版式 (by @NeuralAIInsight) -->
### Case 187: [王者仍在呼吸題頭版式](https://x.com/NeuralAIInsight/status/2067291988953567706) (by [@NeuralAIInsight](https://x.com/NeuralAIInsight))

| Output |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="images/ui_case187/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 王者仍在呼吸題頭版式"></a> |
...
> **26 個精選案例** — [瀏覽全部對比範例 →](cases/comparison.md)
...
<!-- Case 105: 硬幣金額編輯測試 (by @iamaiistudio) -->
### Case 105: [硬幣金額編輯測試](https://x.com/iamaiistudio/status/2065994787094983151) (by [@iamaiistudio](https://x.com/iamaiistudio))
...
### Case 106: [藍圖與渲染分屏物件](https://x.com/iamaiistudio/status/2067202108303311255) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 藍圖與渲染分屏物件"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 藍圖與渲染分屏物件"></a></td></tr>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output3.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 藍圖與渲染分屏物件"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case106/output4.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 藍圖與渲染分屏物件"></a></td></tr>
</table>
...
### Case 107: [涼棚藍圖與實景搭建分屏](https://x.com/iamaiistudio/status/2067142493389603170) (by [@iamaiistudio](https://x.com/iamaiistudio))

<table>
<tr><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 涼棚藍圖與實景搭建分屏"></a></td><td width="50%"><a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case107/output2.jpg" width="100%" alt="GPT-Image-2 Prompt Example - 涼棚藍圖與實景搭建分屏"></a></td></tr>
</table>
...
透過 Issue 提交 prompt：使用我們的 [Prompt Submission Template](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml)，提交你的 prompt 和輸出圖片。

提交 Pull Request：按照既有格式，把你的案例直接加入對應的 `cases/*.md` 檔案中。

回報問題：發現失效連結或不準確的 prompt？可以 [Open an issue](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new)。

**提交規範：**
- 包含完整、可重用的 prompt 文字（不要只寫描述）
- 附上或連結至少一張輸出圖片
- 說明你的 prompt 屬於哪個類別
- 如果分享的是他人作品，請標註原作者

詳細規範請查看 [CONTRIBUTING.md](contributing.md)。

## 致謝

本倉庫受到優秀開放 prompt 合集和社群共享 GPT-Image-2 實驗的啟發。

感謝所有公開分享作品的創作者與貢獻者，讓這些案例研究成為可能。
