...
**來源**: [@Goodmanprotocol](https://x.com/Goodmanprotocol/status/2066048157805629937)
...
| 輸出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="../images/character_case24/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 韓式舞蹈動作分解表"></a> |
...
| 輸出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="../images/character_case25/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 輝光檔案守護者角色海報"></a> |
...
**來源**: [@iamaiistudio](https://x.com/iamaiistudio/status/2067308176715001944)

**輸出效果:**

| 輸出效果 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-API-and-Prompts" target="_blank" rel="noopener noreferrer"><img src="../images/character_case26/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 視覺小說角色檔案頁"></a> |
...
---
### Case 27: 中世紀鍊金術士角色設定頁

**來源**: [@itsPixieVerse](https://x.com/itsPixieVerse/status/2067750004178215241)
